<%@ Page Language="C#"  MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_Disponible_Bodega.aspx.cs" Inherits="Diverscan.MJP.UI.Consultas.Administracion.wf_Disponible_Bodega" %>
                        ...
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               <telerik:RadTabStrip  AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1"  MultiPageID="RadMultiPage1" SelectedIndex="0" >
                                <Tabs>
                                    <telerik:RadTab Text="Disponibilidad de Articulos en Bodega" Width="200px"></telerik:RadTab>
                                </Tabs>
                                </telerik:RadTabStrip>
                                    ...
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_OC">
                                                <h1 class="TituloPanelTitulo">Articulos Disponibles</h1>
                                            ...
                                            <h1 class="TituloPanelTitulo">Articulos Bodega</h1> 
                                            </asp:Panel>
                                            <telerik:RadGrid ID="RadGridArticulosDisponibles" AllowPaging="True" Width="100%" OnClientClick="DisplayLoadingImage1()" 
                                                        runat="server" AutoGenerateColumns="False" AllowSorting="True" PageSize="10" AllowMultiRowSelection="true" >
                                                         <MasterTableView>
                                                            <Columns>
                                                              <telerik:GridBoundColumn UniqueName="IdTID"
                                                                    SortExpression="IdTID" HeaderText="id TraceID" DataField="IdTID">
                                                                </telerik:GridBoundColumn>

                                                                <telerik:GridBoundColumn UniqueName="IdERP"
                                                                    SortExpression="IdERP" HeaderText="Id ICG" DataField="IdERP">
                                                                </telerik:GridBoundColumn>
                                                                ...
                                                                <telerik:GridBoundColumn UniqueName="Articulo"
                                                                    SortExpression="Articulo" HeaderText="Descripcion Articulo" DataField="Articulo">
                                                                </telerik:GridBoundColumn>

                                                                 <telerik:GridBoundColumn UniqueName="Ubicacion"
                                                                    SortExpression="Ubicacion" HeaderText="Descripcion Ubicacion" DataField="Ubicacion">
                                                                </telerik:GridBoundColumn>

                                                                <telerik:GridBoundColumn UniqueName="UnidadesInventario"
                                                                    SortExpression="UnidadesInventario" HeaderText="Cantidad" DataField="UnidadesInventario">
                                                                </telerik:GridBoundColumn>
