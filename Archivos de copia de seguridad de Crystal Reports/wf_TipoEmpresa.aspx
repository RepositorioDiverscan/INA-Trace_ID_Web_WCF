<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_TipoEmpresa.aspx.cs" Inherits="Diverscan.MJP.UI.AppsDiverscan.Contratos.Mantenimiento.wf_TipoEmpresa" %>
                    ...
                    <Windows >
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               ...
                               <Tabs>
                                    <telerik:RadTab Text="Tipo Empresa" Width="200px"></telerik:RadTab>
                                ...
                                <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage"  >
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_Contratos_TipoEmpresa">
                                                <h1 class="TituloPanelTitulo">Mantenimiento Tipo Empresa</h1>
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                                             ...
                                             <tr>
                                                 <td>
                                                    <asp:Label ID="Label3" runat="server" Text="ID Tipo Influencia"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox CssClass="TextBoxBusqueda" ID="txtIdTipoEmpresa" runat="server" Width="85px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                            ...
                                            <asp:Panel runat="server"  CssClass="TituloPanelVistaDetalle" ID="Vista_Contratos_TipoEmpresa0">
                                                <h1 class="TituloPanelTitulo">Lista Tipo Empresa</h1>
