                        ...
                        <telerik:RadWindow ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate>
                               <telerik:RadTabStrip  AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1"  MultiPageID="RadMultiPage1" SelectedIndex="0" >
                                <Tabs>
                                    <telerik:RadTab Text="Resultados Inventario" Width="200px"></telerik:RadTab>                                    
                                </Tabs>
                                </telerik:RadTabStrip>
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                                                <ContentTemplate>
                                                   ...
                                                   <%--          <asp:Image runat="server" ID="Image1" src="../../Images/loading.gif" style="width:80px;height:80px;/>--%>
                                                    ...
                                                    <asp:Panel ID="PanelBaseTomaFisica" runat="server" GroupingText="Inventario Toma Fisica">
                                                           <asp:Label style =" margin-top:2px;" runat="server" ID="_lblFechaAplicado" Text="Fecha Aplicado" ></asp:Label>
                                                           <telerik:RadDatePicker runat="server" ID="_rdpFechaAplicado" AutoPostBack="true" OnSelectedDateChanged="_rdpFechaAplicado_SelectedDateChanged" onchange="DisplayLoadingImage1()"></telerik:RadDatePicker>
                                                           ...
                                                           <asp:Button runat="server" ID="_btnCerrar" Text="Cerrar"  OnClick ="_btnCerrar_Click" />
                                                     
                                                       </asp:Panel> 

                                                    
                                                    <asp:Panel ID="PanelResultados" runat="server" GroupingText="Resultados">

                                                        <telerik:RadGrid ID="RGBodegaFisica_SistemaRecord" Width="100%"  OnNeedDataSource ="RGBodegaFisica_SistemaRecord_NeedDataSource"
                                                            runat="server" AutoGenerateColumns="False" AllowSorting="True"  AllowMultiRowSelection="true"  AllowFilteringByColumn="false"
                                                         >
                                                            <%--Height="200"--%>
                                                         <MasterTableView>
                                                            <Columns>
                                                                ...
                                                                <telerik:GridBoundColumn UniqueName="FVToShow"
                                                                    SortExpression="FVToShow" HeaderText="FV" DataField="FVToShow" Visible ="true">
                                                                </telerik:GridBoundColumn>
                                                       ...
                                                       <h1></h1>
                                                        ...
                                                        <h1></h1>
                                                        <h1></h1>
                                                            <asp:Label runat="server" ID="_lblDiferenciaSAP"  ForeColor="Red"></asp:Label>
                                                        <h1></h1>
                                                        ...
                                                        <%-- <asp:CheckBox runat="server" id ="CheckBox1" Text="IgualSap" Visible ="False"/>--%>
                                                    </asp:Panel>
                                                </ContentTemplate>                                          
                                            </asp:UpdatePanel>                                                                                          
                                            </asp:Panel>
