<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_MaestroEmpaque.aspx.cs" Inherits="Diverscan.MJP.UI.Mantenimiento.Articulos.wf_MaestroEmpaque" %>
                                ...
                                <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage"  >
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_UnidadesEmpaque">
                                                <h1 class="TituloPanelTitulo">Mantenimiento Empaques</h1>
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                                             ...
                                             <tr>
                                                 <td>
                                                    <asp:Label ID="Label3" runat="server" Text="Unidad de Empaque"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox CssClass="TextBoxBusqueda" ID="txtidUnidadEmpaque" runat="server" Width="85px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox CssClass="TexboxNormal" ID="txmDescripcionUnidadEmpaque" runat="server" Width="445px" Height="50px" ></asp:TextBox>
                                                </td>
                                            ...
                                            <asp:Panel runat="server"  CssClass="TituloPanelVistaDetalle" ID="Vista_UnidadesEmpaque0">
