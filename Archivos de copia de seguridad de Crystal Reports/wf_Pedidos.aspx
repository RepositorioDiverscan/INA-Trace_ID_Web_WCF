<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="wf_Pedidos.aspx.cs" Inherits="Diverscan.MJP.UI.Salidas.Requisicion.wf_ConsultaRequisicion" %>
                        ...
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               <telerik:RadTabStrip  AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1"  MultiPageID="RadMultiPage1" SelectedIndex="0" >
                                <Tabs>
                                    <telerik:RadTab Text="Consulta Requisiciones" Width="200px"></telerik:RadTab>
                                    <telerik:RadTab Text="Tab 2" Width="200px"></telerik:RadTab>
                                    <telerik:RadTab Text="Tab 3" Width="200px"></telerik:RadTab>
                                </Tabs>
                                </telerik:RadTabStrip>
                                <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage"  >
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_Requisiciones">
                                                <h1 class="TituloPanelTitulo">Titulo Tab 1</h1>
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                                                <ContentTemplate>
                                                     ...
                                                     <asp:Button  ID="btnAccion1" runat ="server" Text= "Agregar" Width ="150px" OnClick="btnAgregar_Click" /> />
                                                    <asp:Button ID ="btnAccion2" runat ="server" Text= "Editar" Width ="150px" OnClick="btnEditar_Click"/>
                                                     <h1></h1>  
                                                  <table width="100%" style="border-radius: 10px; border: 1px solid grey; width: 100%; border-collapse: initial;" id="Table1">                      
                                            <tr>
                                                 <td>
                                                    <asp:Label ID="Label3" runat="server" Text="Numero Requisición"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox CssClass="TextBoxBusqueda" ID="txtIdRequisicion" runat="server" Width="85px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox runat="server" ID="txtFecha" Class="TexboxNormal" Width="150px" ></asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label2" runat="server" Text="Solicitante"></asp:Label>
                                                </td>
                                                <td>
                                                  <asp:DropDownList ID="ddlidSolicitante" runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>      
                                                <td>
                                                    <asp:Label ID="Label4" runat="server" Text="Fecha Maxima"></asp:Label>       
                                                </td>
                                                <td>
                                                    <asp:TextBox CssClass="TexboxNormal" ID="txtFechaMaxima" runat="server" Width="305px" ></asp:TextBox>  
                                                </td>
                                                  <td> 
                                             ...
                                             <tr>      
                                                <td>
                                                    <asp:Label ID="Label7" runat="server" Text="Tipo Estado"></asp:Label>       
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddlidEstado" runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>  
                                                </td>      
                                            </tr>                       
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:TextBox CssClass="TexboxNormal" ID="txmObservaciones" runat="server" Width="300px" TextMode="MultiLine" Height="50px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>

                                                    <asp:Label ID="Label22" runat="server" Text="Destino"></asp:Label>
                                                </td>
                                                <td>
                                                     <asp:DropDownList ID="ddlidDestino" runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>
                                                </td>
                                                                           
                                                <td>
                                                     <asp:Label ID="Label23" runat="server" Text="Almacen"></asp:Label>
                                                </td>
                                                <td>
                                                   <asp:TextBox CssClass="TexboxNormal" ID="txtIdAlmacen" runat="server" Width="305px" ></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>  
                                                <td>
                                                     <asp:Label ID="Label24" runat="server" Text="Visto"></asp:Label>
                                                </td>
                                                <td>
                                                   <asp:TextBox CssClass="TexboxNormal" ID="txtVisto" runat="server" Width="305px" ></asp:TextBox>
                                                </td>
                                                <td>
                                                      <asp:Label ID="Label25" runat="server" Text="Aprobador"></asp:Label>

                                                </td>
                                                <td >
                                                   <asp:TextBox CssClass="TexboxNormal" ID="txtIdUsuarioAprob" runat="server" Width="305px" ></asp:TextBox>
                                                </td>
                                            </tr>

                                                      <tr>  
                                                <td>
                                                     <asp:Label ID="Label27" runat="server" Text="Visto por el Administrador"></asp:Label>
                                                </td>
                                                <td>
                                                   <asp:TextBox CssClass="TexboxNormal" ID="txtveradmin" runat="server" Width="305px" ></asp:TextBox>
                                                </td>
                                                <td>
                                                      <asp:Label ID="Label28" runat="server" Text="Enviado"></asp:Label>

                                                </td>
                                                <td >
                                                   <asp:TextBox CssClass="TexboxNormal" ID="txtEnvio" runat="server" Width="305px" ></asp:TextBox>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                     <asp:Label ID="Label26" runat="server" Text="Fecha Aprobación"></asp:Label>
                                                </td>
                                                <td >
                                                    <asp:TextBox CssClass="TexboxNormal" ID="txtFechaAprob" runat="server" Width="305px" ></asp:TextBox>
                                                </td>
                                            </tr>                                              
                                              </table>  
                                            ...
                                            <asp:Panel runat="server"  CssClass="TituloPanelVistaDetalle" ID="Vista_Requisiciones0">
