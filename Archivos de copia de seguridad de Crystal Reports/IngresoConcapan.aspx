<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IngresoConcapan.aspx.cs" Inherits="Diverscan.MJP.UI.Concapan.IngresoConcapan" %>
                    ...
                    <Windows >
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               ...
                               <Tabs>
                                    <telerik:RadTab Text="Ajuste Inventario" Width="200px"></telerik:RadTab>
                                        ...
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                                                <ContentTemplate> 
                                                    ...
                                                    <asp:Button  ID="btnAccion91" runat ="server" Text ="Leer" Width ="150px" OnClick="btnAccion91_Click" />
                                                    <asp:Button ID ="btnAccion92" runat ="server" Text ="Limpiar" Width ="150px" />  
                                                    <h1></h1>
                                             ...
                                             <tr>
                                                ...
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtIdentificacion" Width="550px" ></asp:TextBox>
                                             ...
                                             <td></td>
                                                <td>
                                                    <asp:CheckBox runat="server" ID="CheckAlmuerzo" Text="Verificar Almuerzo" />
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                             <td></td>
                                                <td>
                                                    <asp:CheckBox runat="server" ID="CheckCena" Text="Verificar Cena" />
                                                </td>
                                            </tr>
                                              </table>
