                                            ...
                                            <ContentTemplate>
                                                ...
                                                <table style="border-radius: 10px; border: 1px solid grey; width: 100%; border-collapse: initial;">
                                                    <tr>
                                                        ...
                                                        <td style="width:130px"">
                                                            <asp:TextBox CssClass="TextBoxBusqueda" ID="txtidRegistro" runat="server" Width="85px" AutoCompleteType="Disabled"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width:130px"">
                                                            <asp:DropDownList ID="ddTipoAjuste" runat="server" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="ddTipoAjuste_SelectedIndexChanged"></asp:DropDownList>
                                                        </td>
                                                        <td style="width:130px"">
