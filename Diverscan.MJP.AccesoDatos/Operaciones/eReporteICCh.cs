...
{
    [Serializable]
    public class eReporteICCh
    {
        private int idMaestroIngresoCajaChica;
        private string _idInterno;
        private string _descCorta;
        private DateTime _fechaCreacion;
        private string _numValeCajaChica;
        ...
        public eReporteICCh(IDataReader reader)
        {
            IdMaestroIngresoCajaChica = Convert.ToInt32(reader["IdMaestroIngresoCajaChica"]);
            IdInterno = Convert.ToString(reader["IdInterno"]);
            DescCorta = Convert.ToString(reader["DescripcionCorta"]);
            FechaCreacion = Convert.ToDateTime(reader["FechaCreacion"]);
            NumValeCajaChica = Convert.ToString(reader["NumeroValeCajaChica"]);
        ...
        public int IdMaestroIngresoCajaChica { get => idMaestroIngresoCajaChica; set => idMaestroIngresoCajaChica = value; }
        ...
        public string NumValeCajaChica { get => _numValeCajaChica; set => _numValeCajaChica = value; }
