...
namespace Diverscan.MJP.AccesoDatos.Certificación
{
    ...
    public class e_Certificacion
    {
        ...
        public e_Certificacion(IDataReader reader)
        {
        ...
        public e_Certificacion(long idMaestroSolicitud, string UsuarioNombre, DateTime FechaCreacion, string Nombre, string Comentarios,
            string IdCompania, string DestinoNombre, string idInterno, string idInternoSAP, int prioridad, DateTime fechaEntrega, 
            string PorcetajeAlisto, int CantidadAlistada, int CantidadDisponibles)
        {
            ...
            _cantidadDisponible = CantidadDisponibles;
        }
        ...
        public int CantidadAlistada
        {
            get => _cantidadAlistada;
            set => _cantidadAlistada = value;
        }
