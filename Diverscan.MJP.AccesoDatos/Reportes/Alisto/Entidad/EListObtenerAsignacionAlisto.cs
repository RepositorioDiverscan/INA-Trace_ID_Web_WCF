...
namespace Diverscan.MJP.AccesoDatos.Reportes.Alisto.Entidad
{
    ...
    public class EListObtenerAsignacionAlisto
    {
        ...
        private string _sku, _sPorcAlisto;
        private string _nombreArticulo;
        private int _unidadesPendiente;
        private float _unidadesAsignadas, _porcAlisto;
        ...
        public EListObtenerAsignacionAlisto(IDataReader reader )
        {
            ...
            _porcAlisto = (float)Convert.ToDouble(reader["PorcAlistado"]);
            _sPorcAlisto =  Convert.ToString(_porcAlisto) + "%";
        }
        ...
        public float PorcAlisto { get => _porcAlisto; set => _porcAlisto = value; }
        public string Sku { get => _sku; set => _sku = value; }
        public string SPorcAlisto { get => _sPorcAlisto; set => _sPorcAlisto = value; }
    }
}
