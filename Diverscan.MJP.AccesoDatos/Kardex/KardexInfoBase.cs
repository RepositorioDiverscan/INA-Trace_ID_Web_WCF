...
namespace Diverscan.MJP.AccesoDatos.Kardex
{
    [Serializable]
    public class KardexInfoBase
    {
        public KardexInfoBase(long idRegistro, bool sumUno_RestaCero, long idArticulo, DateTime fechaVencimiento,
        ...
        public KardexInfoBase(IDataReader reader)
        {
        ...
        public KardexInfoBase(bool sumUno_RestaCero, long idArticulo, DateTime fechaVencimiento,
          string lote, int idUsuario, long idMetodoAccion, string idTablaCampoDocumentoAccion, string idCampoDocumentoAccion,
          string numDocumentoAccion, long idUbicacion, decimal cantidad, bool procesado, DateTime fecharegistro, int idEstado)
        {
            SumUno_RestaCero = sumUno_RestaCero;
        ...
        public string MetodoAccion { set; get; }
    }
}
