<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EstadoTransaccional.aspx.cs" Inherits="Diverscan.MJP.UI.Mantenimiento.Motor_de_Desiciones.EstadoTransaccional" %>
                        ...
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               <telerik:RadTabStrip  AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1"  MultiPageID="RadMultiPage1" SelectedIndex="0" >
                                <Tabs>
                                    <telerik:RadTab Text="Estado Transaccional" Width="200px"></telerik:RadTab>
                                ...
                                <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage"  >
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_EstadoTransaccional">
                                            ...
                                            <tr>
                                                 <td>
                                                    <asp:Label ID="Label3" runat="server" Text="Id Estado Transaccional"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox CssClass="TextBoxBusqueda" ID="txtIdEstadoTransaccional" runat="server" Width="85px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="Label2" runat="server" Text="Base de Datos "></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddlBaseDatos" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="True" OnSelectedIndexChanged="ddlBaseDatos_SelectedIndexChanged"></asp:DropDownList>
                                                </td>
                                            </tr>

                                              <tr>
                                                <td> 
                                                    <asp:Label ID="Label6" runat="server" Text="Tabla"></asp:Label> 
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddlidTabla" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="True" OnSelectedIndexChanged="ddlidTabla_SelectedIndexChanged"></asp:DropDownList>
                                                </td>
                                                      ...
                                                      <tr>
                                                <td> 
                                                    <asp:Label ID="Label7" runat="server" Text="Metodo Accion"></asp:Label> 
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddlidMetodoAccion" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="True" OnSelectedIndexChanged="ddlidTabla_SelectedIndexChanged"></asp:DropDownList>
                                                </td>
                                                                                     
                                            </tr>
                                            <tr>      
                                                <td>
                                                    <asp:Label ID="Label4" runat="server" Text="Campo"></asp:Label>       
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddlIdCampo" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="True"></asp:DropDownList>
                                                </td>
                                                  <td> 
                                                    <asp:Label ID="Label5" runat="server" Text="Suma_Resta"></asp:Label>       
                                                </td>
                                                <td>
                                                    <asp:TextBox CssClass="TexboxNormal" ID="txtSumUno_RestaCero" runat="server" Width="305px" ></asp:TextBox>
                                                </td>   
                                            </tr>  
                                            ...
                                            <asp:Panel runat="server"  CssClass="TituloPanelVistaDetalle" ID="Vista_EstadoTransaccional0">
