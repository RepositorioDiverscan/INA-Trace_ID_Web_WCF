<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReferenciasMotor.aspx.cs" Inherits="Diverscan.MJP.UI.Mantenimiento.Motor_de_Desiciones.ReferenciasMotor" %>
                        ...
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               <telerik:RadTabStrip  AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1"  MultiPageID="RadMultiPage1" SelectedIndex="0" >
                                <Tabs>
                                    <telerik:RadTab Text="Referencias" Width="200px"></telerik:RadTab>
                                ...
                                <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage"  >
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_ReferenciasMotor">
                                                <h1 class="TituloPanelTitulo">Mantenimiento Referencias</h1>
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                                               ...
                                               <tr>
                                                 <td>
                                                    <asp:Label ID="Label3" runat="server" Text="ID Referencia"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox CssClass="TextBoxBusqueda" ID="txtIdReferencia" runat="server" Width="85px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                                    <asp:Button runat="server" ID="btnBuscar" Text="Buscar" OnClick="btnBuscar_Click"  />
                                                       ...
                                                       <tr>
                                                <td> 
                                                    <asp:Label ID="Label24" runat="server" Text="Base de Datos WMS"></asp:Label> 
                                                </td>
                                                <td>
                                                   <asp:DropDownList ID="dlBaseDatos" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="True" OnSelectedIndexChanged="ddlBaseDatos_SelectedIndexChanged"></asp:DropDownList>
                                                </td>
                                           ...
                                           <tr>
                                                <td> 
                                                    <asp:Label ID="Label25" runat="server" Text="Tabla"></asp:Label> 
                                                </td>
                                                <td>
                                                   <asp:DropDownList ID="dlIdTabla" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="True" OnSelectedIndexChanged="ddlTabla_SelectedIndexChanged"></asp:DropDownList>
                                                </td>
                                            ...
                                            <tr>
                                                <td> 
                                                    <asp:Label ID="Label27" runat="server" Text="Tabla WMS"></asp:Label> 
                                                </td>
                                                <td>
                                                    <asp:TextBox CssClass="TexboxNormal" ID="txtTablaWMS" runat="server" Width="305px" ></asp:TextBox>
                                                </td>

                                                   <tr>
                                                 <td>
                                                    <asp:Label ID="Label6" runat="server" Text="PrimaryKey"></asp:Label>       
                                                </td>
                                                <td>
                                                     <asp:CheckBox runat="server" Text="SincronizaERP" ID="chkPrimaryKey"/> 
                                                </td>
                                                   ...
                                                   <tr>
                                                 <td>
                                                    <asp:Label ID="Label22" runat="server" Text="Fecha Modificacion"></asp:Label>       
                                                </td>
                                                <td>
                                                    <asp:TextBox CssClass="TexboxNormal" ID="dtmFechaModificacion" runat="server" Width="305px" ></asp:TextBox>  
                                                </td>
                                               ...
                                               <tr>      
                                                  ...
                                                  <td> 
                                                    <asp:Label ID="Label23" runat="server" Text="Compañia"></asp:Label>       
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddlIdCompania" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="True" ></asp:DropDownList>
                                                </td>   
                                            </tr>           
                                             ...
                                             <tr>      
                                                ...
                                                <td>
                                                    <asp:TextBox CssClass="TexboxNormal" ID="dtmFechaRegistro" runat="server" Width="305px" ></asp:TextBox>
                                                </td>   
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="Label2" runat="server" Text="Campo WMS"></asp:Label>
                                                </td>
                                                <td>
                                                   <asp:DropDownList ID="ddlCampoWMS" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="True" ></asp:DropDownList>  
                                                      ...
                                                      <tr>
                                                          ...
                                                          <td>
                                                              <h1></h1>
                                                              <asp:Label ID="Label53" runat="server" Text="Zona ERP"></asp:Label>
                                            ...
                                            <tr> 
                                                <td>
                                                    ...
                                                    <asp:Label ID="Label26" runat="server" Text="Base de Datos ERP"></asp:Label>       
                                                </td>
                                                <td>
                                                     <asp:DropDownList ID="dlBaseERP" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="True" OnSelectedIndexChanged="ddlBaseERP_SelectedIndexChanged"></asp:DropDownList>
                                                </td>
                                                 ...
                                                 <td>
                                                    <asp:Label ID="Label4" runat="server" Text="Tabla "></asp:Label>       
                                                </td>
                                                <td>
                                                     <asp:DropDownList ID="dlTablaERP" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="True" OnSelectedIndexChanged="ddlTabla_SelectedIndexChanged1"></asp:DropDownList>  
                                                </td>
                                                      </tr>
                                                 ...
                                                 <td>
                                                    <asp:Label ID="Label1" runat="server" Text="Tabla ERP"></asp:Label>       
                                                </td>
                                                <td>
                                                   <asp:TextBox CssClass="txtTablaErp" ID="txtTablaERP" runat="server" Width="305px" ></asp:TextBox>
                                                </td>
                                                      </tr>
                                               ...
                                               <tr>      
                                                  ...
                                                  <td> 
                                                    <asp:Label ID="Label5" runat="server" Text="Campo ERP"></asp:Label>       
                                                </td>
                                                <td>
                                                     <asp:DropDownList ID="ddlCampoERP" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="True" ></asp:DropDownList>  
                                                </td>   
                                            </tr>
                                            ...
                                            <asp:Panel runat="server"  CssClass="TituloPanelVistaDetalle" ID="Vista_ReferenciasMotor0">
                                                <h1 class="TituloPanelTitulo">Lista Referencias</h1>
