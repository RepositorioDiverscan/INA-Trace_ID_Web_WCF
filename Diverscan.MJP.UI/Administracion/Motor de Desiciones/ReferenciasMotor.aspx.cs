...
namespace Diverscan.MJP.UI.Mantenimiento.Motor_de_Desiciones
{
    public partial class ReferenciasMotor : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                CargarDDLS();
                CargarNombreBases(e_BaseDatos.NombreBD(), dlBaseDatos);
                CargarNombreBases(e_BaseDatos.NombreBD(), dlBaseERP);              
            }
        }

        private string CargarTablaWMS(DropDownList DDL1, DropDownList DDL2 ,  DropDownList DDLActualizar) 
        {
            string dato = DDL1.SelectedValue.ToString() + DDL2.SelectedValue.ToString();
            return dato;
        }

        private void CargarNombreBases(string NombreBD, DropDownList DDL)
        {
            DDL.Items.Clear();
        ...
        private void CargarNombreColumnas(DropDownList DDL)
        {
            try
            {
            DDL.Items.Clear();
            string tabla = "'" + dlIdTabla.SelectedValue.ToString().Substring(4) + "'";
            DataSet DSBaseDatos = new DataSet();
            ...
            if (DSBaseDatos != null)
            {
                if (DSBaseDatos.Tables[0].Rows.Count > 0)
                {
                    foreach (DataRow dsRowEvento in DSBaseDatos.Tables[0].Rows)
                    {
                        string name = dsRowEvento["COLUMN_NAME"].ToString();
                        DDL.Items.Add(name);
                    }
                    DDL.Items.Insert(0, new ListItem("--Seleccionar--"));
                }
            ...
            {
                Mensaje("error", "Ops! Ha ocurrido un Error, Codigo:TID-UI-MAN-MDD-000009" + ex.Message, "");
            }
        }

        protected void ddlTabla_SelectedIndexChanged(object sender, EventArgs e)
        {
            txtTablaWMS.Text = dlBaseDatos.SelectedValue + dlIdTabla.SelectedValue;
            CargarNombreColumnas(ddlCampoWMS);
        }
        ...
        private void CargarAccionesPagina(string Pagina)
        {
            ...
            {
                Mensaje("error", "Ops! Ha ocurrido un Error, Codigo:TID-UI-MAN-MDD-000010" + ex.Message, "");
            }
        }
        ...
        private void CargarDDLS()
        {
            try
            {
                string[] Msj = n_SmartMaintenance.CargarDDL(dlIdTabla, e_TablasBaseDatos.VistaTablasEstadoTransaccional(), UsrLogged.IdUsuario, false);
                ...
                if (Msj[1] != "") Mensaje(Msj[0], Msj[1], "");
                Msj = n_SmartMaintenance.CargarDDL(ddlCampoWMS, e_TablasBaseDatos.VistaCampoWMS(), UsrLogged.IdUsuario, false);
                if (Msj[1] != "") Mensaje(Msj[0], Msj[1], "");
                Msj = n_SmartMaintenance.CargarDDL(ddlCampoERP, e_TablasBaseDatos.VistaCampoERP(), UsrLogged.IdUsuario, false);
                if (Msj[1] != "") Mensaje(Msj[0], Msj[1], "");
                n_SmartMaintenance.CargarDDLsHoras(Panel3);
            }
            catch (Exception ex)
            {
                Mensaje("error", "Ops! Ha ocurrido un Error, Codigo:TID-UI-MAN-MDD-000011" + ex.Message, "");
            }
        }
        ...
        protected void ToggleRowSelection(object sender, EventArgs e)
        {
            ...
            {
                Mensaje("error", "Ops! Ha ocurrido un Error, Codigo:TID-UI-MAN-MDD-000012" + ex.Message, "");
            }
        }
        ...
        protected void ToggleSelectedState(object sender, EventArgs e)
        {
            ...
            {
                Mensaje("error", "Ops! Ha ocurrido un Error, Codigo:TID-UI-MAN-MDD-000013" + ex.Message, "");
            }
        }
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            Control Ctr = (Control)sender;
            var Panel = Ctr.Parent.Parent.Parent;
            string[] Msj = n_SmartMaintenance.AgregarDatos(Panel, e_TablasBaseDatos.TblMDReferencias(), ToleranciaAgregar, UsrLogged.IdUsuario);
            if (Msj[1] != "") Mensaje(Msj[0], Msj[1], "");
        }
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            Control Ctr = (Control)sender;
            var Panel = Ctr.Parent.Parent.Parent;
            string[] Msj = n_SmartMaintenance.EditarDatos(Panel, e_TablasBaseDatos.TblMDReferencias(), UsrLogged.IdUsuario);
            if (Msj[1] != "") Mensaje(Msj[0], Msj[1], "");
        }
        ...
        protected void ddlBaseDatos_SelectedIndexChanged(object sender, EventArgs e)
        {
            CargarNombreTablas(e_BaseDatos.NombreBD(), dlIdTabla);
        }

        #endregion //TabsControl

        protected void ddlBaseERP_SelectedIndexChanged(object sender, EventArgs e)
        {
            CargarNombreTablas(e_BaseDatos.NombreBD(), dlTablaERP);
        }

        protected void ddlTabla_SelectedIndexChanged1(object sender, EventArgs e)
        {
            txtTablaERP.Text = dlBaseERP.SelectedValue + dlTablaERP.SelectedValue;
        }
    }
}