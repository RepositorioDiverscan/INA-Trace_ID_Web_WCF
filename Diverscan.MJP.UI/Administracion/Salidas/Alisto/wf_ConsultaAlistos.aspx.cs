...
namespace Diverscan.MJP.UI.Salidas.Alistos
{
    public partial class wf_ConsultaAlistos : System.Web.UI.Page
    {
        ...
        private void CargarDDLS()
        {
            ...
            {
                Mensaje("error", "Ops! Ha ocurrido un Error, Codigo: TID-UI-ADM-SAL-000001" + ex.Message, "");
            }
        }
        ...
        protected void ToggleRowSelection(object sender, EventArgs e)
        {
            ...
            {
                Mensaje("error", "Ops! Ha ocurrido un Error, Codigo: TID-UI-ADM-SAL-000002" + ex.Message, "");
            }
        }
        ...
        protected void ToggleSelectedState(object sender, EventArgs e)
        {
            ...
            {
                Mensaje("error", "Ops! Ha ocurrido un Error, Codigo: TID-UI-ADM-SAL-000003" + ex.Message, "");
            }
        }
        ...
        protected void btnAgregar2_Click(object sender, EventArgs e)
        {
            ...
            string[] Msj = n_SmartMaintenance.AgregarDatos(Panel, TblTab21Mantenimiento, ToleranciaAgregar, UsrLogged.IdUsuario);
            if (Msj[1] != "") Mensaje(Msj[0], Msj[1], "");
        }
        ...
        protected void btnEditar2_Click(object sender, EventArgs e)
        {
            Control Ctr = (Control)sender;
            var Panel = Ctr.Parent.Parent.Parent;
            string[] Msj = n_SmartMaintenance.EditarDatos(Panel, TblTab21Mantenimiento, UsrLogged.IdUsuario);
            if (Msj[1] != "") Mensaje(Msj[0], Msj[1], "");
        }
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            Control Ctr = (Control)sender;
            var Panel = Ctr.Parent.Parent.Parent;
            string[] Msj = n_SmartMaintenance.AgregarDatos(Panel, e_TablasBaseDatos.TblMaestroAlisto(), ToleranciaAgregar, UsrLogged.IdUsuario);
            if (Msj[1] != "") Mensaje(Msj[0], Msj[1], "");
        }
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            Control Ctr = (Control)sender;
            var Panel = Ctr.Parent.Parent.Parent;
            string[] Msj = n_SmartMaintenance.EditarDatos(Panel,  e_TablasBaseDatos.TblMaestroAlisto(), UsrLogged.IdUsuario);
            if (Msj[1] != "") Mensaje(Msj[0], Msj[1], "");
        }
