<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_HorariosBodega.aspx.cs" Inherits="Diverscan.MJP.UI.Administracion.Operacion.wf_HorariosBodega" %>
                        ...
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               <telerik:RadTabStrip  AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1"  MultiPageID="RadMultiPage1" SelectedIndex="0" >
                                <Tabs>
                                    <telerik:RadTab Text="Horario Bodega" Width="200px"></telerik:RadTab>
                                ...
                                <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage"  >
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_HorarioBodega">
                                                <h1 class="TituloPanelTitulo">Datos del Horario</h1>
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <table width="100%" style="border-radius: 10px; border: 1px solid grey; width: 100%; border-collapse: initial;" id="Table1">                      
                                                    <tr>
                                                            <td>
                                                            <asp:Label ID="Label3" runat="server" Text="Num. Horario Bodega"></asp:Label> 
                                                        </td>
                                                        <td >     
                                                            <asp:TextBox CssClass="TextBoxBusqueda" ID="txtidHorarioBodega" runat="server" Width="50px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                                    ...
                                                    <td>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlidBodega" Class="TexboxNormal"  runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    <td> 
                                                    ...
                                                    <tr>
                                                    <td> 
                                                        <asp:Label ID="Label2" runat="server" Text="Cantidad Max Empleados"></asp:Label> 
                                                    </td>
                                                    <td>
                                                        <asp:TextBox runat="server" ID="txtCantMaxEmpleados" Class="TexboxNormal" Width="50px" ></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr> 
                                                    <td>
                                                        <asp:Label ID="Label17" runat="server" Text="Dia"></asp:Label> 
                                                    </td>
                                                        <td>
                                                 ...
                                                 <tr> 
                                                    <td>
                                                        <asp:Label ID="Label18" runat="server" Text="Hora Entrada"></asp:Label> 
                                                    </td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlidHoraEntrada" Class="TexboxNormal"  runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>
                                                        </td>
                                                </tr>
                                                     <tr> 
                                                    <td>
                                                        <asp:Label ID="Label19" runat="server" Text="Hora Salida"></asp:Label> 
                                                    </td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlidHoraSalida" Class="TexboxNormal"  runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>
                                                        </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txmComentarios"  Width="500px" Height="30px"  TextMode="MultiLine"   ></asp:TextBox>
                                                    </td>
                                                </tr>  
                                            ...
                                            <asp:Panel runat="server"  CssClass="TituloPanelVistaDetalle" ID="Vista_HorarioBodega0">
                                                <h1 class="TituloPanelTitulo">Listado Horarios por Bodega (no debe existir mas de un horario por bodega)</h1> 
                                            </asp:Panel>
                                          ...
                                          <asp:UpdatePanel runat="server" ID="UpdatePanel2">
                                             <ContentTemplate>   
                                                 ...
                                                 <table width="100%" style="border-radius: 10px; border: 1px solid grey; width: 100%; border-collapse: initial;" id="Table2">                      
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="ddlidTipoDestino" Class="TexboxNormal"  runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>
                                                    </td>
                                                    </tr>
                                                    <tr>
                                                    <td>
                                   ...
                                   <telerik:RadPageView runat="server" ID="RadPageView3">                                  
                                        <asp:Panel ID="Panel3" runat="server" Class="TabContainer"  >                                        
                                            ...
                                            <h1></h1>
                                                ...
                                                <td >     
                                                    <asp:TextBox CssClass="TextBoxBusqueda" ID="txtidRestricconDestino" runat="server" Width="85px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlidDia00" Class="TexboxNormal"  runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>
                                                </td>
                                                </tr> 
                                                 <tr> 
                                                <td>
