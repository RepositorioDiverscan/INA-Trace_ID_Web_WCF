                                    ...
                                    <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                           
                                        <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                                            <ContentTemplate>    
                                                ...
                                                <!--Campo del Nombre del Ajuste-->    
                                                <asp:Label runat="server" ID="_lblNombre" Text="Nombre" style="margin-left:5px;"></asp:Label>
                                                <asp:TextBox runat ="server" ID="_txtNombre" style="margin-top:10px;"></asp:TextBox>                                                       
                                                ...
                                                <telerik:RadDatePicker runat ="server" ID="_rdpFechaPorAplicar">
