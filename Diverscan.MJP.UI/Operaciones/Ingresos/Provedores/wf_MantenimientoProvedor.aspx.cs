...
namespace Diverscan.MJP.UI.Operaciones.Ingresos.Provedores
{
    public partial class wf_MantenimientoProvedor : System.Web.UI.Page
    {
        ...
        private void CargarDDLS()
        {
            try
            {
                ...
                //string Sql2 = "select IDUSUARIO, Nombre from [TRACEID].[dbo].[Usuarios] WHERE idCompania = 'AMCO'  order by Nombre";
                //n_WMS.CargarDropGood(ddlIDUSUARIO, Sql2, "0");
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            Control Ctr = (Control)sender;
            var Panel = Ctr.Parent.Parent.Parent;
            string[] Msj = n_SmartMaintenance.AgregarDatos(Panel, e_TablasBaseDatos.TblADMProveedor(), ToleranciaAgregar, UsrLogged.IdUsuario);
            if (Msj[1] != "") Mensaje(Msj[0], Msj[1], "");
        }
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            Control Ctr = (Control)sender;
            var Panel = Ctr.Parent.Parent.Parent;
            string[] Msj = n_SmartMaintenance.EditarDatos(Panel, e_TablasBaseDatos.TblADMProveedor(), UsrLogged.IdUsuario);
            if (Msj[1] != "") Mensaje(Msj[0], Msj[1], "");
        }
