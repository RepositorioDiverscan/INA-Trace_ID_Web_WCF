<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_IngresoTrasladoBodegas.aspx.cs" Inherits="Diverscan.MJP.UI.Operaciones.Ingresos.wf_IngresoTrasladoBodegas" %>
        ...
        <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="btnBuscar">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="RadGridOPEINGTrasladoBodega"></telerik:AjaxUpdatedControl>
                    </UpdatedControls>
                </telerik:AjaxSetting>
                <telerik:AjaxSetting AjaxControlID="RadGridOPEINGTrasladoBodega">
                    <UpdatedControls>
                    ...
                    <telerik:RadWindow ID="WinUsuarios" runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID" AutoSize="true">
                        ...
                        <ContentTemplate>
                            ...
                            <telerik:RadTabStrip AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" SelectedIndex="0">
                                <Tabs>
                                    <telerik:RadTab Text="Traslado entre Bodegas" Width="200px"></telerik:RadTab>
                                </Tabs>
                            </telerik:RadTabStrip>
                            ...
                            <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
                                ...
                                <telerik:RadPageView runat="server" ID="RadPageView1">
                                    ...
                                    <asp:Panel ID="Panel1" runat="server" Class="TabContainer">
                                        ...
                                        <%-- Maestro Ingreso Traslado entre Bodegas --%>
                                        <asp:Panel runat="server" CssClass="TituloPanelVista" ID="Vista_OrdenesCompra">
                                            <h1 class="TituloPanelTitulo">Datos</h1>
                                        ...
                                        <asp:Panel runat="server" CssClass="TituloPanelVistaDetalle" ID="Vista_DetalleIngresoTrasladoBodega">
                                            <h1 class="TituloPanelTitulo">Listado Traslado entre Bodegas</h1>
                                        </asp:Panel>

                                        <telerik:RadGrid RenderMode="Lightweight" AutoGenerateColumns="false" ID="RadGridOPEINGTrasladoBodega"
                                            ...
                                            DataKeyNames="IdMaestroIngresoTraslado"
                                            ...
                                            <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="True" ShowFooter="True"
                                                ClientDataKeyNames="IdMaestroIngresoTraslado">
                                                <Columns>

                                                    <telerik:GridBoundColumn FilterControlWidth="50px" DataField="IdMaestroIngresoTraslado" HeaderText="ID">
                                                    ...
                                                    <telerik:GridBoundColumn FilterControlWidth="120px" DataField="Proveedor" HeaderText="Bodega Proveniente"
                                                    ...
                                                    <telerik:GridBoundColumn DataField="FechaProcesamiento" HeaderText="Fecha procesamiento" DataFormatString="{0:dd/MM/yyyy}">
                                                        <FooterStyle Font-Bold="true"></FooterStyle>
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </telerik:GridBoundColumn>
                                        ...
                                        <asp:Panel runat="server" CssClass="TituloPanelVistaDetalle" ID="Panel2">
                                            <h1 class="TituloPanelTitulo">Listado Detalle Traslado entre Bodega</h1>
                                        </asp:Panel>

                                        <%--Detalle Traslado Bodegas--%>
                                        <telerik:RadGrid RenderMode="Lightweight" AutoGenerateColumns="false" ID="RadGridDetalleIngreso" HeaderStyle-HorizontalAlign="center"
                                            ...
                                            ShowFooter="True" AllowPaging="True" runat="server" OnSelectedIndexChanged="RadGridDetalleIngreso_SelectedIndexChanged"
                                            InsertItemPageIndexAction="ShowItemOnFirstPage" OnItemCommand="RadGrid1_ItemCommand"
                                            OnNeedDataSource="RadGridDetalleTrasladoBodega_NeedDataSource" PagerStyle-AlwaysVisible="true">
                                            ...
                                            <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="True" ShowFooter="True">
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="Nombre" HeaderText="Nombre del articulo"
                                                        AutoPostBackOnFilter="true" CurrentFilterFunction="Contains"
                                                        ShowFilterIcon="false">
                                                    </telerik:GridBoundColumn>
