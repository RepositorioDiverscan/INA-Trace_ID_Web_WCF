...
{
    public partial class wf_DespachoPedidos : System.Web.UI.Page
    {
        private readonly IDespachoDePedidos DespachoDePedidos;
        public wf_DespachoPedidos()
        {
        ...
        protected void btnFacturar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    //DespachoDePedidos.FacturarOla(idOla);
                    PanelDetalle.Visible = false;
        ...
        protected void RGDetalleOla_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
        {
