...
{
    public partial class wf_ProcesarDespacho : System.Web.UI.Page
    {
        ...
        { 
            //TraceID.(2016). Operaciones/Ingresos/wf_UbicarArticulo.En Trace ID Codigos documentados(18).Costa Rica:Grupo Diverscan. 
        }
        ...
        protected void ToggleRowSelection(object sender, EventArgs e)
        {
            ...
            {
                Mensaje("error", "Ops! Ha ocurrido un Error, Codigo:TID-UI-MAN-MDD-000007" + ex.Message, "");
            }
        }
        ...
        protected void ToggleSelectedState(object sender, EventArgs e)
        {
            ...
            {
                Mensaje("error", "Ops! Ha ocurrido un Error, Codigo:TID-UI-MAN-MDD-000008" + ex.Message, "");
            }
        }
