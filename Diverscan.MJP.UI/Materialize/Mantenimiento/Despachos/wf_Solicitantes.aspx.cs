...
{
    public partial class wf_Solicitantes : System.Web.UI.Page
    {
        ...
        private void CargarAccionesPagina(string Pagina)
        {
            ...
            {
                Mensaje("error", "Ops! Ha ocurrido un Error, Codigo:TID-UI-MAN-DES-000007" + ex.Message, "");
            }
        }
        ...
        private void CargarDDLS()
        {
            ...
            {
                Mensaje("error", "Ops! Ha ocurrido un Error, Codigo:TID-UI-MAN-DES-000008" + ex.Message, "");
            }
        }
        ...
        protected void ToggleRowSelection(object sender, EventArgs e)
        {
            ...
            {
                Mensaje("error", "Ops! Ha ocurrido un Error, Codigo:TID-UI-MAN-DES-000009" + ex.Message, "");
            }
        }
        ...
        protected void ToggleSelectedState(object sender, EventArgs e)
        {
            ...
            {
                Mensaje("error", "Ops! Ha ocurrido un Error, Codigo:TID-UI-MAN-DES-000010" + ex.Message, "");
            }
        }
