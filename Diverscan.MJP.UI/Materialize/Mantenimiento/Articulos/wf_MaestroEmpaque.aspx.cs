...
{
    public partial class wf_MaestroEmpaque : System.Web.UI.Page
    {
        ...
        {
            //TraceID.(2016). Mantenimiento/Articulos/wf_MaestroEmpaque.En Trace ID Codigos documentados(4).Costa Rica:Grupo Diverscan. 
        }
        ...
        protected void ToggleRowSelection(object sender, EventArgs e)
        {
            ...
            {
                Mensaje("error", "Ops! Ha ocurrido un Error, Codigo: TID-UI-MAN-ART-000007" + ex.Message, "");
            }
        }
        ...
        protected void ToggleSelectedState(object sender, EventArgs e)
        {
            ...
            {
                Mensaje("error", "Ops! Ha ocurrido un Error, Codigo: TID-UI-MAN-ART-000008" + ex.Message, "");
            }
        }
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            Control Ctr = (Control)sender;
            var Panel = Ctr.Parent.Parent.Parent;
            string[] Msj = n_SmartMaintenance.AgregarDatos(Panel, e_TablasBaseDatos.TblUnidadesEmpaque(), ToleranciaAgregar, UsrLogged.IdUsuario);
            if (Msj[1] != "") Mensaje(Msj[0], Msj[1], "");
        }
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            Control Ctr = (Control)sender;
            var Panel = Ctr.Parent.Parent.Parent;
            string[] Msj = n_SmartMaintenance.EditarDatos(Panel, e_TablasBaseDatos.TblUnidadesEmpaque(), UsrLogged.IdUsuario);
            if (Msj[1] != "") Mensaje(Msj[0], Msj[1], "");
        }
