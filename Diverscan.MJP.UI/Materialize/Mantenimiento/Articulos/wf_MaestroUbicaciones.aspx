                                ...
                                <telerik:RadPageView runat="server" ID="RadPageView1">
                                    <asp:Panel ID="Panel1" runat="server" Class="TabContainer">
                                        <asp:Panel runat="server" CssClass="TituloPanelVista" ID="Vista_Almacen">
                                            <h1 class="TituloPanelTitulo">Mantenimiento Almacen</h1>
                                            ...
                                            <ContentTemplate>
                                               ...
                                               <%--          <asp:Image runat="server" ID="Image1" src="../../Images/loading.gif"" style="width:80px;height:80px;/>--%>
                                                ...
                                                <table width="100%" style="border-radius: 10px; border: 1px solid grey; width: 100%; border-collapse: initial;" id="Table1">
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label3" runat="server" Text="ID Almacen"></asp:Label>
                                                        </td>
                                               ...
                                               <%--          <asp:Image runat="server" ID="Image1" src="../../Images/loading.gif"" style="width:80px;height:80px;/>--%>
                                                ...
                                                <table width="100%" style="border-radius: 10px; border: 1px solid grey; width: 100%; border-collapse: initial;" id="Table3">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox CssClass="TexboxNormal" ID="txtestante" runat="server" Width="300px" MaxLength="3" placeholder="Ejemplo: 000" AutoPostBack="True" OnTextChanged="TxtMinValid_TextChanged"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox CssClass="TexboxNormal" ID="txtcolumna" runat="server" Width="300px" Visible="True" MaxLength="3" type="number" min="0" AutoPostBack="True" OnTextChanged="TxtMinValid_TextChanged"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox CssClass="TexboxNormal" ID="txtnivel" runat="server" Width="300px" MaxLength="3" min="0" type="number" AutoPostBack="True" OnTextChanged="TxtMinValid_TextChanged"
                                                                oninput="javascript: if (this.value.length> this.maxLength) this.value = this.value.slice (0, this.maxLength);" onkeydown="return onlyNos(event)" placeholder="Ejemplo: 000"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox CssClass="TexboxNormal" ID="txtpos" runat="server" Width="300px" Visible="True" AutoPostBack="True" OnTextChanged="TxtMinValid_TextChanged"
                                                                type="number" min="0" oninput="javascript: if (this.value.length> this.maxLength) this.value = this.value.slice (0, this.maxLength);" MaxLength="3" onkeydown="return onlyNos(event)" placeholder="Ejemplo: 000"></asp:TextBox>
