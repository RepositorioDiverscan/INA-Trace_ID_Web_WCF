...
{
    public partial class wf_FamiliaArticulo : System.Web.UI.Page
    {
        ...
        private void CargarDDLS()
        {
            try
            {
                //string[] Msj = n_SmartMaintenance.CargarDDL(ddlidArticulo, e_TablasBaseDatos.TblMaestroArticulos(), UsrLogged.IdUsuario);
                //if (Msj[1] != "") Mensaje(Msj[0], Msj[1], "");
                //Msj = n_SmartMaintenance.CargarDDL(ddlIDUSUARIO, e_TablasBaseDatos.VistaUsuariosSinAdmin(), UsrLogged.IdUsuario);
                //if (Msj[1] != "") Mensaje(Msj[0], Msj[1], "");
