                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList runat="server" ID="ddBodega" CssClass="TexboxNormal" Width="250px"
                                                                    AutoPostBack="true" OnSelectedIndexChanged="ddBodega_SelectedIndexChanged"/>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td> 
                                                            ...
                                                            <td> 
                                                                <asp:Label ID="alertName" runat="server" Text="*" style="color:red" visible="false"></asp:Label> 
                                                            </td>
                                                        </tr>                                                    
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td> 
                                                                <asp:Label ID="alertPhone" runat="server" Text="*" style="color:red" visible="false"></asp:Label> 
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td> 
                                                                <asp:Label ID="alertMail" runat="server" Text="*" style="color:red" visible="false"></asp:Label> 
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <tr>
                                                              <td>
                                                                  <asp:Label ID="Label18" runat="server" Text="Activo" style ="margin-top:8px; margin-left:5px;" ></asp:Label> 
                                                              </td>
                                                              <td>
                                                                  <asp:CheckBox runat="server" ID="_chkActivo" ></asp:CheckBox>
                                                              </td>
                                                            </tr>
                                                    </table>
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <telerik:GridBoundColumn UniqueName="Correo"
                                                                 ...
                                                                 <telerik:GridBoundColumn UniqueName="idBodega" 
                                                                    SortExpression="idBodega" HeaderText="IdBodega" DataField="idBodega"  Display="false">
                                                                </telerik:GridBoundColumn>
                                                                ...
                                                                <telerik:GridBoundColumn UniqueName="Comentarios"
                                                                 ...
                                                                 <telerik:GridBoundColumn UniqueName="activo"
                                                                    SortExpression="activo" HeaderText="Activo" DataField="activo" Display="false">
                                                                </telerik:GridBoundColumn>
                                                               <telerik:GridTemplateColumn UniqueName="Activo" HeaderText="Activo"> 
                                                                 <ItemTemplate> 
                                                                    <asp:Label ID="Label19" runat="server" 
                                                                        Text='<%# Convert.ToBoolean(Eval("activo")) == true ? "Si" : "No" %>'/> 
                                                                 </ItemTemplate> 
                                      ...
                                      <asp:Panel ID="Panel2" runat="server" Class="TabContainer">    
                                        <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_Vehiculos">
                                                ...
                                                <center>
                                                 ...
                                                 <table width="100%" style="border-radius: 10px; border: 1px solid grey; width: 100%; border-collapse: initial;" id="Table2">                      
                                                    ...
                                                    <%--<asp:Button runat="server" ID="Button1" Text="Buscar"  OnClientClick="DisplayLoadingImage2()" OnClick="btnBuscar_Click"  />--%>
                                                     ...
                                                     <tr> 
                                                         <td>
                                                            <asp:Label ID="Label16" runat="server" Text="Compañia"></asp:Label> 
                                                         </td>
                                                         <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label24" runat="server" Text="Bodega"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList runat="server" ID="ddlBodegasVehiculo" CssClass="TexboxNormal" Width="250px"
                                                                AutoPostBack="true" OnSelectedIndexChanged="ddlBodegasVehiculo_SelectedIndexChanged"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <td>
                                                     ...
                                                     <tr>
                                                     <td> 
                                                        <asp:Label ID="Label22" runat="server" Text="Marca Vehículo"></asp:Label>       
                                                    </td>
                                                    <td>
                                                    ...
                                                    <tr>
                                                    <td>
                                                        <asp:Label ID="Label20" runat="server" Text="Activo" style ="margin-top:8px; margin-left:5px;" ></asp:Label> 
                                                    </td>
                                                    <td>
                                                        <asp:CheckBox runat="server" ID="_chkActivoVehiculo" ></asp:CheckBox>
                                                    </td>
                                                    </tr>
                                         ...
                                         <telerik:RadGrid ID="RadGridVehiculos" AllowPaging="True" Width="100%" OnClientClick="DisplayLoadingImage1()"  OnNeedDataSource ="RadGridVehiculos_NeedDataSource"
                                                        runat="server" AutoGenerateColumns="False" AllowSorting="True" PageSize="10" AllowMultiRowSelection="true" OnItemCommand="RadGridVehiculos_ItemCommand" PagerStyle-AlwaysVisible="true">
                                                         <MasterTableView>
                                                            <Columns>
                                                                ...
                                                                <telerik:GridBoundColumn UniqueName="TipoVehiculo"
                                                                    SortExpression="TipoVehiculo" HeaderText="Tipo Vehiculo" DataField="TipoVehiculo">
                                                                </telerik:GridBoundColumn>                                                              

                                                                <telerik:GridBoundColumn UniqueName="Marca"
                                                                    SortExpression="Marca" HeaderText="Marca Vehiculo" DataField="Marca">
                                                                </telerik:GridBoundColumn>

                                                                <telerik:GridBoundColumn UniqueName="Color"
                                                                    SortExpression="Color" HeaderText="Color" DataField="Color">
                                                                </telerik:GridBoundColumn>
                                                                ...
                                                                <telerik:GridBoundColumn UniqueName="IdInternoBodega"
                                                                    SortExpression="IdInternoBodega" HeaderText="Bodega" DataField="IdInternoBodega">
                                                                </telerik:GridBoundColumn>
