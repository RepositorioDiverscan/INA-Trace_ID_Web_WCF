<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SolicitudDevolucionReporte.aspx.cs" Inherits="Diverscan.MJP.UI.Reportes.SolicitudDevolucion.SolicitudDevolucionReporte" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="solicitudDevolucionReporte" style="margin-left: 20%">     

        <!--Titulo del Reporte-->
        <h3 style="font-size: 25px !important;">Reportes de Solicitudes de Devolución</h3>
    ...
    <script src="ReporteSolicitudDevolucion.js"></script>
