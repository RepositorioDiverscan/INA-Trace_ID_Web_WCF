const despachadoVsRecibidoReporte = new Vue({

    el: '#despachadoVsRecibidoReporte',
    ...
    methods: {
        ...
        buscarReporte() {
            ...
            let self = this;
            $.post('DespachadoVsRecibidoAjax.aspx', {
                opcion: 'ObtenerReporte',
        ...
        generarExcel() {
            ...
            XLSX.utils.book_append_sheet(workbook, worksheet, "Despachado Vs Recibido");
            XLSX.writeFile(workbook, "DespachadoVsRecibidoReporte.xlsx");
