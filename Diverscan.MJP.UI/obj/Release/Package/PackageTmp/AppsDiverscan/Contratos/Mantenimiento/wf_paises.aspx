<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_paises.aspx.cs" Inherits="Diverscan.MJP.UI.AppsDiverscan.Contratos.Mantenimiento.wf_paises" %>
                    ...
                    <Windows >
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               ...
                               <Tabs>
                                    <telerik:RadTab Text="Paises" Width="200px"></telerik:RadTab>
                                ...
                                <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage"  >
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_Paises">
                                                <h1 class="TituloPanelTitulo">Mantenimiento paises</h1>
                                           ...
                                           <tr>
                                                 <td>
                                                    <asp:Label ID="Label3" runat="server" Text="ID Pais"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox CssClass="TextBoxBusqueda" ID="txtIdPais" runat="server" Width="85px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                             ...
                                             <tr>
                                                 <td>
                                                    <asp:Label ID="Label2" runat="server" Text="Nombre en Español"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtNombreEs" Width="250px" ></asp:TextBox>
                                            ...
                                            <asp:Panel runat="server"  CssClass="TituloPanelVistaDetalle" ID="Vista_Paises0">
                                                <h1 class="TituloPanelTitulo">Lista Paises</h1>
