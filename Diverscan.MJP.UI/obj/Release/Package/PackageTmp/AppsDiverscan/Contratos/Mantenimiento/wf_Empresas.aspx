<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_Empresas.aspx.cs" Inherits="Diverscan.MJP.UI.AppsDiverscan.Contratos.Mantenimiento.wf_Empresas" %>
                    ...
                    <Windows >
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               ...
                               <Tabs>
                                    <telerik:RadTab Text="Mantenimiento Empresas" Width="200px"></telerik:RadTab>
                                ...
                                <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage"  >
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_Contratos_Empresas">
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                                             ...
                                             <tr>
                                                ...
                                                <td >     
                                                    <asp:TextBox CssClass="TextBoxBusqueda" ID="txtIdEmpresa" runat="server" Width="85px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                             ...
                                             <tr>
                                                 <td>
                                                    <asp:Label ID="Label1" runat="server" Text="Cedula Juridica"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtCedulaJuridica" Width="250px" ></asp:TextBox>
                                                ...
                                                <td >     
                                                    <asp:DropDownList ID="ddlIdPais" runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>                
                                                </td>
                                            </tr>
                                                ...
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtRazonSocial" Width="250px" ></asp:TextBox>
                                                ...
                                                <td >     
                                                   ...
                                                   <tr>
                                                <td>
                                                   <asp:CheckBox runat="server" Text="Casa Matriz" ID="chkCasaMatriz"/>
                                                </td>
                                              ...
                                              <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="Label7" runat="server" Text="Dirección Fisica"></asp:Label> 
                                                </td>
                                                <td >     
                                                       <asp:TextBox CssClass="TexboxNormal" ID="txmDireccion" runat="server" Width="300px" TextMode="MultiLine" Height="50px"></asp:TextBox>              
                                                </td>
                                            </tr>
                                               ...
                                               <tr>
                                                 ...
                                                 <td>
                                                    <asp:Label ID="Label22" runat="server" Text="Credito Empresa"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:DropDownList ID="ddlIdCreditoEmpresa" runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>                
                                                </td>

                                                <td>
                                                    <asp:Label ID="Label6" runat="server" Text="Tipo Relación"></asp:Label> 
                                                </td>
                                                <td >     
                                                      <asp:DropDownList ID="ddlIdTipoRelacion" runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>              
                                                </td>
                                            </tr>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="Label24" runat="server" Text="Segmentación Empresa"></asp:Label> 
                                                </td>
                                                <td >     
                                                      <asp:DropDownList ID="ddlIdSegmentacionEmpresa" runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>              
                                                </td>
                                            </tr>


                                            <td>
                                                    <asp:Label ID="Label30" runat="server" Text="Tipo Empresa"></asp:Label> 
                                                </td>
                                                <td >     
                                                      <asp:DropDownList ID="ddlIdTipoEmpresa" runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>              
                                                </td>
                                            </tr>
                                          ...
                                          <tr>
                                                 ...
                                                 <td>
                                                    <asp:Label ID="Label25" runat="server" Text="Descuento Empresa"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:DropDownList ID="ddlIdDescuentoEmpresa" runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>                
                                                </td>

                                                <td>
                                                    <asp:Label ID="Label26" runat="server" Text="Vendedor Empresa"></asp:Label> 
                                                </td>
                                                <td >     
                                              ...
                                              <tr>
                                                 ...
                                                 <td>
                                                    <asp:Label ID="Label27" runat="server" Text="Industria Empresa"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:DropDownList ID="ddlIdIndustriaEmpresa" runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>                
                                                </td>

                                                <td>
                                                    <asp:Label ID="Label28" runat="server" Text="Impuesto Empresa"></asp:Label> 
                                                </td>
                                                <td >     
                                                      <asp:DropDownList ID="ddlIdImpuestoEmpresa" runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>              
                                                </td>
                                            </tr>
                                           ...
                                           <tr>
                                                ...
                                                <td >     
                                                       <asp:TextBox CssClass="TexboxNormal" ID="txtTelefono" runat="server" Width="300px" TextMode="MultiLine" Height="50px"></asp:TextBox>              
                                                </td>
                                               ...
                                               <td>
                                                ...
                                                <td >     
                                                       <asp:TextBox CssClass="TexboxNormal" ID="txtEmail" runat="server" Width="300px" TextMode="MultiLine" Height="50px"></asp:TextBox>              
                                                </td>
                                            ...
                                            <asp:Panel runat="server"  CssClass="TituloPanelVistaDetalle" ID="Vista_Contratos_Empresas0">
