<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GeneraTarea.aspx.cs" Inherits="Diverscan.MJP.UI.Operaciones.Tareas.GeneraTarea" %>
                                    ...
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_Sinonimos">
                                                <h1 class="TituloPanelTitulo">Generar Tarea</h1>
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                                             ...
                                             <tr>
                                                ...
                                                <td >     
                                                    <asp:TextBox CssClass="TextBoxBusqueda" ID="txtidTarea" runat="server" Width="85px" AutoCompleteType="Disabled" ></asp:TextBox>
                                                </td>
                                            </tr>
                                             ...
                                             <tr>
                                                ...
                                                <td >     
                                                    <asp:TextBox  CssClass="TexboxNormal"  ID="txtTarea" runat="server"  TextMode="MultiLine" Height="300px" Width="285px" ></asp:TextBox>   
                                                    <asp:Image ID="ImgEspera" runat="server" ImageUrl="~/Images/espera02.gif" Visible ="true"/>
                                                </td>
                                            </tr>
                                                
                                              </table>
                                                    
                                             <asp:Button  runat ="server" ID="btnAccion12" Text ="Siguiente Tarea" Width ="150px" OnClick="SiguienteTarea"/>  
