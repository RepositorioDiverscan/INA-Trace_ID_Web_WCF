<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_TiempoTarea.aspx.cs" Inherits="Diverscan.MJP.UI.Administracion.Relacion.wf_TiempoTarea" %>
                        ...
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               <telerik:RadTabStrip  AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1"  MultiPageID="RadMultiPage1" SelectedIndex="0" >
                                <Tabs>
                                    <telerik:RadTab Text="Rel Acción Tiempo" Width="200px"></telerik:RadTab>
                                    <telerik:RadTab Text="Detalle Traslado"  Visible ="false" Width="200px" ></telerik:RadTab>
                                ...
                                <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage"  >
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_AccionTiempo">
                                                <h1 class="TituloPanelTitulo">Mantenimiento Acción Tiempo</h1>
                                            ...
                                            <tr>
                                                 <td>
                                                    <asp:Label ID="Label3" runat="server" Text="Id Accion Tiempo"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox CssClass="TextBoxBusqueda" ID="txtidRelAccionTiempo" runat="server" Width="85px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                                    <asp:Button runat="server" ID="btnBuscar" Text="Buscar" OnClick="btnBuscar_Click"  />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td> 
                                                    <asp:Label ID="Label1" runat="server" Text="Nombre Metodo Accion"></asp:Label> 
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlTabla" runat="server" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="ddlTabla_SelectedIndexChanged"></asp:DropDownList>
                                                </td>  
                                                </tr>
                                             ...
                                             <tr>
                                                <td> 
                                                    <asp:Label ID="Label4" runat="server" Text="PrimaryKey Objeto"></asp:Label> 
                                                </td>
                                                <td>
                                                    <asp:TextBox runat="server" ID="txtPKObjeto" Class="TexboxNormal" Width="150px" ></asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label7" runat="server" Text="PrimaryKey Valor"></asp:Label>
                                                </td>
                                                <td>
                                                     <asp:DropDownList ID="ddlPkValue" runat="server" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="ddlTabla_SelectedIndexChanged"></asp:DropDownList>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td> 
                                                    <asp:Label ID="Label8" runat="server" Text="Tiempo Estimado"></asp:Label> 
                                                </td>
                                                <td>
                                                    <asp:TextBox runat="server" ID="txtTiempoEstimado" Class="TexboxNormal" Width="150px" ></asp:TextBox>
                                                </td> 
                                            </tr>                
                                              </table>  
                                            ...
                                            <asp:Panel runat="server"  CssClass="TituloPanelVistaDetalle" ID="Vista_AccionTiempo0">
                                                <h1 class="TituloPanelTitulo">Lista AjusteInventario</h1>
                                    ...
                                    <telerik:RadPageView runat="server" ID="RadPageView2">
                                      <asp:Panel ID="Panel2" runat="server" Class="TabContainer">    
                                        <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_DetalleTraslado">
                                            <h1 class="TituloPanelTitulo">Detalle Traslado</h1>
                                          ...
                                          <asp:UpdatePanel runat="server" ID="UpdatePanel2">
                                             <ContentTemplate>   
                                                 ...
                                                 <asp:Button  ID="Button5" runat ="server" Text= "Agregar" Width ="150px" OnClick="btnAgregar2_Click" />
                                                 <asp:Button ID ="Button6"  runat ="server" Text= "Editar" Width ="150px"  OnClick="btnEditar2_Click"/>     
                                            ...
                                            <tr>
                                                 <td>
                                                    <asp:Label ID="Label6" runat="server" Text="Id Tipo Traslado"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox CssClass="TextBoxBusqueda" ID="txtidDetalleTraslado" runat="server" Width="85px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                            ...
                                            <tr>      
                                                  ...
                                                  <td> 
                                                    <asp:Label ID="Label12" runat="server" Text="Tipo Traslado"></asp:Label>       
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddlidTipoTraslado0" runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>
                                                </td>   
                                            </tr>  
                                              ...
                                              <tr>      
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlidZona" runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>
                                                </td>   
                                            </tr>  
                                                               
                                             <tr>                                                     
                                                <td>
                                                    <asp:CheckBox runat="server" Text="Origen/Destino" ID="chkOrigenDestino"/>
                                                </td>   
                                            </tr>  
                                         ...
                                         <asp:Panel runat="server"  CssClass="TituloPanelVistaDetalle" ID="Vista_DetalleTraslado0">
