<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Contextos.aspx.cs" Inherits="Diverscan.MJP.UI.Mantenimiento.Motor_de_Desiciones.Contextos" %>
                                ...
                                <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage"  >
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_Contextos">
                                                <h1 class="TituloPanelTitulo">Mantenimiento Contextos</h1>
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                                             ...
                                             <tr>
                                                 <td>
                                                    <asp:Label ID="Label3" runat="server" Text="ID Contexto"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox CssClass="TextBoxBusqueda" ID="txtidMDContexto" runat="server" Width="85px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                             ...
                                             <tr>      
                                                ...
                                                <td>
                                                    <asp:TextBox CssClass="TexboxNormal" ID="txtNombre" runat="server" Width="305px" ></asp:TextBox>
                                                </td>
                                            ...
                                            <tr>
                                                <td> 
                                                    <asp:Label ID="Label1" runat="server" Text="Signo de Puntuación"></asp:Label> 
                                                </td>
                                                <td>
                                                   <asp:DropDownList ID="ddlidMDSignoPuntuacion" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="True"></asp:DropDownList>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label2" runat="server" Text="Tipo de Contexto "></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddlidMDTipoContexto" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="True" ></asp:DropDownList>
                                                </td>
                                            </tr>
                                            ...
                                            <asp:Panel runat="server"  CssClass="TituloPanelVistaDetalle" ID="Vista_Contextos0">
