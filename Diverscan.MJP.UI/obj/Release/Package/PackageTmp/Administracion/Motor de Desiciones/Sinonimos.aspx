<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Sinonimos.aspx.cs" Inherits="Diverscan.MJP.UI.Mantenimiento.Motor_de_Desiciones.Sinonimos" %>
                        ...
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               <telerik:RadTabStrip  AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1"  MultiPageID="RadMultiPage1" SelectedIndex="0" >
                                <Tabs>
                                    <telerik:RadTab Text="Sinonimos" Width="200px"></telerik:RadTab>
                                ...
                                <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage"  >
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_Sinonimos">
                                                <h1 class="TituloPanelTitulo">Mantenimiento Sinonimos</h1>
                                            ...
                                            <tr>
                                                 <td>
                                                    <asp:Label ID="Label3" runat="server" Text="ID Sinonimo"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox CssClass="TextBoxBusqueda" ID="txtidMDSinonimo" runat="server" Width="85px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                                    <asp:Button runat="server" ID="btnBuscar" Text="Buscar" OnClick="btnBuscar_Click"  />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td> 
                                                    <asp:Label ID="Label1" runat="server" Text="Tipo de Palabra"></asp:Label> 
                                                </td>
                                                <td>
                                                   <asp:DropDownList ID="ddlidMDTipoPalabra" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="True"></asp:DropDownList>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label2" runat="server" Text="Contexto "></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddlidMDContexto" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="True" ></asp:DropDownList>
                                                </td>
                                            </tr>

                                              <tr>
                                                <td> 
                                                    <asp:Label ID="Label6" runat="server" Text="Metodo Accion"></asp:Label> 
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddlidMetodoAccion" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="True" ></asp:DropDownList>
                                                </td>
                                            ...
                                            <tr>      
                                                <td>
                                                    <asp:Label ID="Label4" runat="server" Text="Palabra"></asp:Label>       
                                                </td>
                                                <td>
                                                    <asp:TextBox CssClass="TexboxNormal" ID="txtPalabra" runat="server" Width="305px" ></asp:TextBox>
                                                </td>
                                                  <td> 
                                                    <asp:Label ID="Label5" runat="server" Text="Sinonimo"></asp:Label>       
                                                </td>
                                                <td>
                                                    <asp:TextBox CssClass="TexboxNormal" ID="txtSinonimo" runat="server" Width="305px" ></asp:TextBox>
                                                </td>   
                                            </tr>  
                                            ...
                                            <asp:Panel runat="server"  CssClass="TituloPanelVistaDetalle" ID="Vista_Sinonimos0">
