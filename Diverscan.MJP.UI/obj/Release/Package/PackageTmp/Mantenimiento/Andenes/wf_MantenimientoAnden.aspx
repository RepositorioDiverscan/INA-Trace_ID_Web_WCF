<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_MantenimientoAnden.aspx.cs" Inherits="Diverscan.MJP.UI.Mantenimiento.Andenes.wf_MantenimientoAnden" %>
                    ...
                    <Windows >
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               ...
                               <Tabs>
                                    <telerik:RadTab Text="Mantenimiento Anden" Width="200px"></telerik:RadTab>
                                ...
                                <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage"  >
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_OPEINGAnden">
                                                <h1 class="TituloPanelTitulo">Mantenimiento Andenes</h1>
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                                             ...
                                             <tr>
                                                 <td>
                                                    <asp:Label ID="Label3" runat="server" Text="Anden"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox CssClass="TextBoxBusqueda" ID="txtIdAnden" runat="server" Width="85px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                            ...
                                            <tr>
                                                 <td>
                                                    <asp:Label ID="Label2" runat="server" Text="Hora Entrada"></asp:Label> 
                                                </td>
                                                <td >     
                                                <asp:DropDownList ID="ddlidHoraEntrada" runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>
                                                </td>
                                            </tr>
                                       
                                             <tr>
                                                 <td>
                                                    <asp:Label ID="Label4" runat="server" Text="Hora Salida"></asp:Label> 
                                                </td>
                                                <td >     
                                                <asp:DropDownList ID="ddlidHoraSalida" runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>
                                                </td>
                                            </tr>
                                            ...
                                            <asp:Panel runat="server"  CssClass="TituloPanelVistaDetalle" ID="Vista_OPEINGAnden0">
