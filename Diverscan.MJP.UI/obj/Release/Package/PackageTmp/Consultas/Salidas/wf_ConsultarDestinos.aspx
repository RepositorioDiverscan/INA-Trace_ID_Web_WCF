<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_ConsultarDestinos.aspx.cs" Inherits="Diverscan.MJP.UI.Consultas.Salidas.wf_ConsultarDestinos" %>
                                    ...
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_OC">
                                                <h1 class="TituloPanelTitulo">Datos del Destino</h1>
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                                                ...
                                                <h1 class="TituloPanelTitulo">Listado de Destinos</h1> 
                                            </asp:Panel>
                                            <telerik:RadGrid ID="RadGridDestino" AllowPaging="True" Width="100%" OnClientClick="DisplayLoadingImage1()"  OnNeedDataSource ="RadGridDestino_NeedDataSource"
                                                        runat="server" AutoGenerateColumns="False" AllowSorting="True" PageSize="10" AllowMultiRowSelection="true" OnItemCommand="RadGridDestino_ItemCommand">
                                                         <MasterTableView>
                                                            <Columns>
