<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_SinOrdenCompra.aspx.cs" Inherits="Diverscan.MJP.UI.Operaciones.Ingresos.wf_SinOrdenCompra" %>
        ...
        <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="btnBuscar">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="RadGridOPEINGSinOrdenDeCompraARecibir"></telerik:AjaxUpdatedControl>
                    </UpdatedControls>
                </telerik:AjaxSetting>
                <telerik:AjaxSetting AjaxControlID="RadGridOPEINGSinOrdenDeCompraARecibir">
                    <UpdatedControls>
                    ...
                    <telerik:RadWindow ID="WinUsuarios" runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID" AutoSize="true">
                        <ContentTemplate>
                            ...
                            <telerik:RadTabStrip AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" SelectedIndex="0">
                                <Tabs>
                                    <telerik:RadTab Text="Sin Orden de Compra" Width="200px"></telerik:RadTab>
                                ...
                                <telerik:RadPageView runat="server" ID="RadPageView1">
                                    ...
                                    <asp:Panel ID="Panel1" runat="server" Class="TabContainer">
                                        ...
                                        <asp:Panel runat="server" CssClass="TituloPanelVista" ID="Vista_OrdenesCompra">
                                            <h1 class="TituloPanelTitulo">Datos Sin Orden de Compra</h1>
                                        ...
                                        <asp:Panel runat="server" CssClass="TituloPanelVistaDetalle" ID="Vista_DetalleSinOrdenCompra">
                                            <h1 class="TituloPanelTitulo">Listado Sin Orden Compra</h1>
                                        </asp:Panel>

                                        <telerik:RadGrid RenderMode="Lightweight" AutoGenerateColumns="false" ID="RadGridOPEINGSinOrdenDeCompraARecibir"
                                            ...
                                            DataKeyNames="IdMaestroSinOrdenCompra"
                                            ...
                                            <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="True" ShowFooter="True"
                                                ClientDataKeyNames="IdMaestroSinOrdenCompra">
                                                <Columns>

                                                    <telerik:GridBoundColumn DataField="IdMaestroSinOrdenCompra" HeaderText="ID">
                                        ...
                                        <asp:Panel runat="server" CssClass="TituloPanelVistaDetalle" ID="Panel2">
                                            <h1 class="TituloPanelTitulo">Listado Detalle Sin Orden Compra</h1>
                                        </asp:Panel>




                                        <%--Detalle Sin Orden de Compra--%>
                                        <telerik:RadGrid RenderMode="Lightweight" AutoGenerateColumns="false" ID="RadGridDetalleIngreso" HeaderStyle-HorizontalAlign="center"
                                            ...
                                            OnNeedDataSource="RadGridDetalleSinOrdenCompra_NeedDataSource" PagerStyle-AlwaysVisible="true">
