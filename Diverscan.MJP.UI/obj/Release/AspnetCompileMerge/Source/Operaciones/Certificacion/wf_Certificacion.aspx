<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_Certificacion.aspx.cs" Inherits="Diverscan.MJP.UI.Operaciones.Certificacion.wf_Certificacion" %>
                    ...
                    <telerik:RadWindow ID="WinUsuarios" runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID" AutoSize="true">
                        <ContentTemplate>
                            <telerik:RadTabStrip AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1">
                                <Tabs>
                                    <telerik:RadTab Text="Certificación" Width="200px"></telerik:RadTab>
                                </Tabs>
                            </telerik:RadTabStrip>
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <table width="100%" style="border-radius: 10px; border: 1px solid grey; width: 100%; border-collapse: initial;" id="TableSector">
                                                    <tr>
                                                        ...
                                                        <td>
                                                          <asp:Button runat="server" ID="btnCertificar" Text="Certificar" AutoPostBack="false" OnClick="btnCertificar_Click" OnClientClick="DisplayLoadingImage1()" />
                                                        </td>
