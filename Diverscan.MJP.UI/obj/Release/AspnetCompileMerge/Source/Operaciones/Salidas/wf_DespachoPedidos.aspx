<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_DespachoPedidos.aspx.cs" Inherits="Diverscan.MJP.UI.Operaciones.Salidas.wf_DespachoPedidos" %>
                    ...
                    <telerik:RadWindow ID="WinUsuarios" runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID" AutoSize="true">
                        <ContentTemplate>
                            <telerik:RadTabStrip AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" SelectedIndex="0">
                                <Tabs>
                                    <telerik:RadTab Text="Asignar Despacho" Width="200px"></telerik:RadTab>
                                </Tabs>
                            </telerik:RadTabStrip>
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <table style="border-radius: 10px; border: 1px solid grey; width: 98%; border-collapse: initial; margin-left: 1%; margin-top: 1%;" id="Table2">
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td>
                                                            <asp:CheckBox ID="cbFacturado" runat="server" AutoPostBack="true" Text="Facturada" />
                                                            <asp:Button runat="server" ID="btnBuscar" Text="Buscar" style="margin-left:25%" AutoPostBack="false" OnClientClick="DisplayLoadingImage1()" OnClick="btnBuscar_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                                <br />
                                                <asp:Panel runat="server" ID="PaneOlas" Visible="false">
                                                    ...
                                                    <telerik:RadGrid ID="RGAprobarSalida" AllowPaging="true" Width="98%" OnNeedDataSource="RGAprobarSalida_NeedDataSource" style="margin-left:1%"  PagerStyle-AlwaysVisible="true"
                                                ...
                                                <asp:Panel runat="server" ID="PanelDetalle" Visible="false">
                                                    ...
                                                    <asp:Button runat="server" ID="btnFacturar" Style="margin-left: 10px" Text="Facturar" OnClick="btnFacturar_Click"/>
