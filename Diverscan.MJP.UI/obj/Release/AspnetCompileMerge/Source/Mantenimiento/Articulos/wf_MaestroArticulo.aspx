                                                ...
                                                <center>
                                                   ...
                                                   <table width="100%" style="border-radius: 10px; border: 1px solid grey; width: 100%; border-collapse: initial;" id="Table1">                      
                                                        ...
                                                        <tr>
                                                            <td></td>
                                                            <td>
                                                                <asp:CheckBox runat="server" ID="chkGranel" Text="¿Es granel?" Visible="false"></asp:CheckBox>
                                                            </td>
                                                        </tr>
                                                      ...
                                                      <%-- <tr>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:CheckBox runat="server" ID="chkActivo" Text="Activo" Checked="true" style="margin-left:15px; margin-right:50px; margin-bottom:15px;"/>
                                                                <asp:CheckBox runat="server" ID="chkTrazable" Text="Con trazabilidad" Checked="true" style="margin:15px; margin-bottom:15px;"/>
                                                    ...
                                                    <telerik:RadGrid ID="RadGridMaestroArticulo" AllowPaging="True" OnNeedDataSource ="RadGridMaestroArticulo_NeedDataSource"
                                                                     OnItemCommand="RadGridMaestroArticulo_ItemCommand" runat="server" AutoGenerateColumns="False" 
                                                                     AllowSorting="True" PageSize="50" AllowMultiRowSelection="false" >
                                                         ...
                                                         <MasterTableView>
                                                            <Columns>
                                                               <%--<telerik:GridClientSelectColumn UniqueName="ClientSelectColumn1">
                                                                ...
                                                                <telerik:GridTemplateColumn HeaderText="Trazable"> 
                                                                    <ItemTemplate> 
                                                                        <asp:Label ID="Label11" runat="server"
                                                                       Text='<%# Convert.ToBoolean(Eval("Contrazabilidad")) == true ? "Si" : "No" %>'/>
                                                                    </ItemTemplate> 
                                                                ...
                                                                <telerik:GridTemplateColumn HeaderText="Activo"> 
                                                                 ...
                                                                 <telerik:GridBoundColumn UniqueName="ConTrazabilidad"
                                                                    SortExpression="ConTrazabilidad" HeaderText="Trazable" DataField="ConTrazabilidad" visible="false">
                                                                </telerik:GridBoundColumn>

                                                                <telerik:GridBoundColumn UniqueName="Activo"
                                                                    SortExpression="Activo" HeaderText="Activo" DataField="Activo" visible="false">
                                                                </telerik:GridBoundColumn>
