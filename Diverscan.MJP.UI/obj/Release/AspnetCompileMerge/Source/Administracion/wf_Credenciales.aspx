        ...
        <div>
            <div class="page">
                    ...
                    <div class="title">
                      <div class="loginDisplay">
                            ...
                            <table class="LogoCrede">
                                <tr>
                                    <td>
                                        <asp:Image runat="server" ID="imgLodoMJP" /> <%-- ImageUrl="../Images/TraceID2.jpg"  
                                        <Image src="../Images/TraceID2.jpg"  runat="server" ID="imgLodoMJP02" />  --%>
                                    </td>
                                </tr>
                        </table><%--End tblLogo--%>
                    </div><%--End title--%>
                ...
                <div class="footer">  
                    ...
                    <br />
                    <%-- <img src="../Images/logos/Logo-INA.png" height="15%" width="15%"/>  --%>
                    <asp:Label ID="Label1" runat="server" Text="Instituto Nacional de Aprendizaje" Font-Bold="true" Font-Italic="true" 
                               ForeColor="black" BackColor="WhiteSmoke">
                    </asp:Label>
                </div>
            </div>
