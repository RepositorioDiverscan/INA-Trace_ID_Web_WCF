<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_CreditoEmpresa.aspx.cs" Inherits="Diverscan.MJP.UI.AppsDiverscan.Contratos.Mantenimiento.wf_CreditoEmpresa" %>
                    ...
                    <Windows >
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               ...
                               <Tabs>
                                    <telerik:RadTab Text="Credito Empresa" Width="200px"></telerik:RadTab>
                                ...
                                <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage"  >
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_Contratos_CreditoEmpresa">
                                                <h1 class="TituloPanelTitulo">Mantenimiento Credito Empresa</h1>
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                                                <ContentTemplate> 
                                                  ...
                                                  <table width="100%" style="border-radius: 10px; border: 1px solid grey; width: 100%; border-collapse: initial;" id="Table1">                      
                                                    ...
                                                    <tr>
                                                    <td>
                                                    <asp:Label ID="Label3" runat="server" Text="ID Credito Empresa"></asp:Label> 
                                                    </td>
                                                    <td >     
                                                        <asp:TextBox CssClass="TextBoxBusqueda" ID="txtIdCreditoEmpresa" runat="server" Width="85px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                                    ...
                                                    <td >     
                                                        <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtPorcentaje" Width="250px" ></asp:TextBox>
                                                    </td>
                                                    </tr>
                                                     <tr>
                                                    <td>
                                                        <asp:Label ID="Label4" runat="server" Text="Clausulas"></asp:Label> 
                                                    </td>
                                                    <td >     
                                                        <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txmClausulas" Width="250px" TextMode="MultiLine" Columns="10" Rows="10" ></asp:TextBox>
                                                    </td>
                                                    </tr>
                                              </table>
                                            ...
                                            <asp:Panel runat="server"  CssClass="TituloPanelVistaDetalle" ID="Vista_Contratos_CreditoEmpresa0">
                                                <h1 class="TituloPanelTitulo">Lista Segementación Empresa</h1>
