<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_Contacto.aspx.cs" Inherits="Diverscan.MJP.UI.AppsDiverscan.Contratos.Mantenimiento.wf_Contacto" %>
                    ...
                    <Windows >
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               ...
                               <Tabs>
                                    <telerik:RadTab Text="Contacto" Width="200px"></telerik:RadTab>
                                ...
                                <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage"  >
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_Contratos_Contacto">
                                                <h1 class="TituloPanelTitulo">Mantenimiento Contacto</h1>
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                                             ...
                                             <tr>
                                                 <td>
                                                    <asp:Label ID="Label3" runat="server" Text="ID Contacto"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox CssClass="TextBoxBusqueda" ID="txtIdContacto" runat="server" Width="85px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                             ...
                                             <tr>
                                                ...
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtApellidos" Width="250px" ></asp:TextBox>
                                              ...
                                              <tr>
                                                ...
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtCedula" Width="250px" ></asp:TextBox>
                                             ...
                                             <tr>
                                                ...
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtCorreo" Width="250px" ></asp:TextBox>
                                              ...
                                              <tr>
                                                 <td>
                                                    <asp:Label ID="Label6" runat="server" Text="Correo 2"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtCorreo2" Width="250px" ></asp:TextBox>
                                              ...
                                              <tr>
                                                ...
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtDireccion" Width="250px" ></asp:TextBox>
                                                ...
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtPuesto" Width="250px" ></asp:TextBox>
                                                ...
                                                <td >     
                                                     ...
                                                     <asp:DropDownList ID="ddlIdEmpresa" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="True"></asp:DropDownList>
                                             ...
                                             <tr>
                                                 <td>
                                                    <asp:Label ID="Label10" runat="server" Text="Tipo Relación"></asp:Label> 
                                                </td>
                                                <td >     
                                                   
                                                     <asp:DropDownList ID="ddlIdTipoRelacion" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="True"></asp:DropDownList>
                                                ...
                                                <tr>
                                                 <td>
                                                    <asp:Label ID="Label11" runat="server" Text="Telefono Empresa"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtTelefonoEmpresa" Width="250px" ></asp:TextBox>
                                           ...
                                           <tr>
                                                ...
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtExt" Width="250px" ></asp:TextBox>
                                           ...
                                           <tr>
                                                 <td>
                                                    <asp:Label ID="Label13" runat="server" Text="Telefono Celular"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtTelefonoCelular" Width="250px" ></asp:TextBox>
                                           ...
                                           <%--   <tr>
                                                 <td>
                                                    <asp:Label ID="Label14" runat="server" Text="Fecha Registro"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtFechaRegistro" Width="250px" ></asp:TextBox>
                                            ...
                                            <asp:Panel runat="server"  CssClass="TituloPanelVistaDetalle" ID="Vista_Contratos_Contacto0">
