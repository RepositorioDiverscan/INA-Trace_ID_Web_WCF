<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_Procesos.aspx.cs" Inherits="Diverscan.MJP.UI.FlujoDeTrabajo.wf_Procesos" %>
                        ...
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               <telerik:RadTabStrip  AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1"  MultiPageID="RadMultiPage1" SelectedIndex="0" >
                                <Tabs>
                                    <telerik:RadTab Text="Proceso" Width="100px"></telerik:RadTab>
                                    <telerik:RadTab Text="Actividad" Width="100px"></telerik:RadTab>
                                    <telerik:RadTab Text="Acciones" Width="100px"></telerik:RadTab>
                                    <telerik:RadTab Text="A. Metodos" Width="110px"></telerik:RadTab>
                                    <telerik:RadTab Text="M. Parametros" Width="130px"></telerik:RadTab>
                                </Tabs>
                                </telerik:RadTabStrip>
                   <%--PROCESOS--%>
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                                                <ContentTemplate>
                                                    ...
                                                    <table width="100%" style="border-radius: 10px; border: 1px solid grey; width: 100%; border-collapse: initial;" id="Table1">                      
                                                        <tr>
                                                             <td>
                                                                <asp:Label ID="Label3" runat="server" Text="Num. Proceso"></asp:Label> 
                                                            </td>
                                                            <td >     
                                                                <asp:TextBox CssClass="TextBoxBusqueda" ID="txtidProceso" runat="server" Width="85px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox CssClass="TexboxNormal" ID="txmDescripcion" runat="server" Width="300px" TextMode="MultiLine" Height="50px"></asp:TextBox>
                                                            </td>
                                                        </tr>                                                                         
                                                    </table>                                             
                                                </ContentTemplate>
                                                ...
                                                <ContentTemplate>                           
                                                 ...
                                                 <table width="100%" style="border-radius: 10px; border: 1px solid grey; width: 100%; border-collapse: initial;" id="Table3">                      
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td >     
                                                            <asp:TextBox CssClass="TexboxNormal" ID="txtNombre00" runat="server" Width="300px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                                        </td>
                                                    </tr>           
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td >     
                                                            <asp:TextBox CssClass="TexboxNormal" ID="txmDescripcion00" runat="server" Width="400px"  TextMode="MultiLine"  Height="75px" ></asp:TextBox>   
                                                        </td>
                                                    </tr>
                                                     <tr>
                                                         <td>
                                                         ...
                                                         <td>
                                                            <asp:DropDownList runat="server" CssClass="TexboxNormal" ID ="ddlFuente" Width="600px" AutoPostBack="false" OnSelectedIndexChanged="ddlFuente_SelectedIndexChanged"></asp:DropDownList>
                                                         </td>
                                                       </tr>
                                                     <tr> 
                                                        <td>
                                                        ...
                                                        <td>
                                                          <asp:DropDownList runat="server" ID ="ddlObjetoFuente" CssClass="TexboxNormal" Width="200px" AutoPostBack="false"></asp:DropDownList>
                                                        </td>                                              
                                                     </tr>
                                                      <tr> 
                                                        <td>
                                                        ...
                                                        <td>
                                                          <asp:DropDownList runat="server" ID ="ddlidEvento" CssClass="TexboxNormal" Width="200px" AutoPostBack="false"></asp:DropDownList>
                                                        </td>                                              
                                                     </tr>
                                                 <h1></h1>
                                                 </table>                               
                   ...
                   <%--METODOS--%>
                                        <telerik:RadPageView runat="server" ID="RadPageView4"  >
                                            <asp:Panel ID="Panel5" runat="server" Class="TabContainer"  > 
                                                    ...
                                                    <ContentTemplate>
                                                        ...
                                                        <table width="100%" style="border-radius: 10px; border: 1px solid grey; width: 100%; border-collapse: initial;" id="Table4">                      
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList ID="ddlidAccion" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="false"></asp:DropDownList>
                                                                </td>   
                                                            </tr>
                                                             <tr>
                                                                <td> 
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList ID="ddlidMetodo" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="false"></asp:DropDownList>
                                                                </td>   
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox CssClass="TexboxNormal" ID="txmDescripcion000" runat="server" Width="300px" TextMode="MultiLine" Height="50px"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                             <tr>
                                                                <td>
                                                            ...
                                                            <tr>
                                                              ...
                                                              <tr>
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList ID="ddlidParametroAccion" Class="TexboxNormal" runat="server" Width="700px" AutoPostBack="false"></asp:DropDownList>
                                                                </td>   
                                                            </tr>
                                                            <tr>
                                                                <td> 
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList ID="ddlidTipoMetodo" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="false"></asp:DropDownList>
                                                                </td>   
                                                            </tr>
                                                        </table>                                             
                                                    </ContentTemplate>
                                                ...
                                                <telerik:RadGrid ID="RadGrid4"  runat="server"  AllowMultiRowSelection="false" PageSize ="10"  onitemcommand="RadGrid_ItemCommand"  OnPreRender="RadGrid4_Prerender" 
                                                            AllowFilteringByColumn="True" AllowPaging="True" AllowSorting="True" Culture="es-ES" ItemStyle-Wrap="False"  OnNeedDataSource="RadGrid_NeedDataSource">
                                                            <ClientSettings EnableRowHoverStyle="true" Selecting-AllowRowSelect="false" EnablePostBackOnRowClick="true">
                                                                 <Selecting AllowRowSelect="false" ></Selecting>
                                                                <Scrolling AllowScroll="True"  UseStaticHeaders="false" SaveScrollPosition="true" FrozenColumnsCount="2"></Scrolling>                                               
                   ...
                   <%--PARAMETROS--%>
                                        <telerik:RadPageView runat="server" ID="RadPageView5"  >
                                            <asp:Panel ID="Panel8" runat="server" Class="TabContainer"  > 
                                                        ...
                                                        <table width="100%" style="border-radius: 10px; border: 1px solid grey; width: 100%; border-collapse: initial;" id="Table5">                      
                                                            <tr>
                                                              ...
                                                              <tr>
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList ID="ddvidAccion0" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="false"  OnSelectedIndexChanged="ddlidAccion0_SelectedIndexChanged"></asp:DropDownList>
                                                                </td>   
                                                            </tr>
                                                            <tr>
                                                                <td> 
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList ID="ddlidMetodoAccion" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="false" OnSelectedIndexChanged="ddlidMetodoAccion_SelectedIndexChanged"></asp:DropDownList>
                                                                </td>   
                                                                </tr>
                                                             <tr>
                                                                <td> 
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList ID="ddlNombre" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="false" OnSelectedIndexChanged="ddlNombre_SelectedIndexChanged"></asp:DropDownList>
                                                                </td>   
                                                                </tr>
                                                             <tr>
                                                                <td> 
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList ID="ddlidTipoParametro" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="false"></asp:DropDownList>
                                                                </td>   
                                                                </tr>
                                                            <tr>
                                                                <td> 
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox CssClass="TexboxNormal" ID="txmDescripcion0000" runat="server" Width="300px" TextMode="MultiLine" Height="50px"></asp:TextBox>
                                                                </td>
                                                            </tr>   
                                                             <tr>
                                                                <td></td>
                                                ...
                                                <telerik:RadGrid ID="RadGrid5"  runat="server"  AllowMultiRowSelection="false" PageSize ="10"  onitemcommand="RadGrid_ItemCommand" OnPreRender="RadGrid5_Prerender"  
                                                            AllowFilteringByColumn="True" AllowPaging="True" AllowSorting="True" Culture="es-ES" ItemStyle-Wrap="False"  OnNeedDataSource="RadGrid_NeedDataSource">
                                                            <ClientSettings EnableRowHoverStyle="true" Selecting-AllowRowSelect="false" EnablePostBackOnRowClick="true">
                                                                    <Selecting AllowRowSelect="false" ></Selecting>
                                                                <Scrolling AllowScroll="True"  UseStaticHeaders="false" SaveScrollPosition="true" FrozenColumnsCount="2"></Scrolling>                                               
