<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_ConsultarSolicitudUniAlisto.aspx.cs" Inherits="Diverscan.MJP.UI.Consultas.Salidas.wf_ConsultarSolicitudUniAlisto" %>
                                                         ...
                                                         <MasterTableView>
                                                            <Columns>
                                                                ...
                                                                <telerik:GridBoundColumn UniqueName="idInternoSAP"
                                                                    SortExpression="idInternoSAP" HeaderText="Id Interno SAP" DataField="idInternoSAP"
                                                                    AllowFiltering="True" AutoPostBackOnFilter="True" CurrentFilterFunction="Contains" ShowFilterIcon="False">
                                                                </telerik:GridBoundColumn>
