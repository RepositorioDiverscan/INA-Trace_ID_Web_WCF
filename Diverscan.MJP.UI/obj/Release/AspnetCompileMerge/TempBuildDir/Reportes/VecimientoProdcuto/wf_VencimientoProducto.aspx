<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_VencimientoProducto.aspx.cs" Inherits="Diverscan.MJP.UI.Reportes.VecimientoProdcuto.wf_VencimientoProducto" %>
                    ...
                    <telerik:RadWindow ID="WinUsuarios" runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID" AutoSize="true">
                        <ContentTemplate>
                            <telerik:RadTabStrip AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" SelectedIndex="0">
                                <Tabs>
                                    <telerik:RadTab Text="Vencimiento de producto" Width="200px"></telerik:RadTab>
                                </Tabs>
                            </telerik:RadTabStrip>
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <table width="98%" style="border-radius: 10px; border: 1px solid grey; border-collapse: initial; margin-left: 1%;margin-top:10px" id="Table1">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <asp:Button runat="server" ID="btnGenerarReporte" Style="margin-left: 10px" Text="GenerarReporte" OnClick="btnGenerarReporte_Click" PostBackUrl="~/Reportes/VecimientoProdcuto/wf_VencimientoProducto.aspx" />
                                                        </td>
                                                    </tr>
                                                ...
                                                <asp:Panel runat="server" ID="PanelRotacionInventario" Visible="true">
                                                    <telerik:RadGrid
                                                        ...
                                                        OnNeedDataSource="RGArticulos_NeedDataSource"
                                                        ...
                                                        <MasterTableView>
                                                            <Columns>
                                                                <telerik:GridBoundColumn UniqueName="DiasVencimiento" Visible="true"
                                                                    SortExpression="DiasVencimiento" HeaderText="Dias Vencimiento" DataField="DiasVencimiento">
                                                                ...
                                                                <telerik:GridBoundColumn UniqueName="NombreProducto"
                                                                    SortExpression="NombreProducto" HeaderText="Nombre de Artículo" DataField="NombreProducto">
                                                                </telerik:GridBoundColumn>

                                                                <telerik:GridBoundColumn UniqueName="Cantidad"
                                                                    SortExpression="Cantidad" HeaderText="Unidades" DataField="Cantidad">
                                                                </telerik:GridBoundColumn>
