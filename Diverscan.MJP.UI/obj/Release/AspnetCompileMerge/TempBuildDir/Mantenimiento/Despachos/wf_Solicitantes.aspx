<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_Solicitantes.aspx.cs" Inherits="Diverscan.MJP.UI.Mantenimiento.Despachos.wf_Solicitantes" %>
                        ...
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               <telerik:RadTabStrip  AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1"  MultiPageID="RadMultiPage1" SelectedIndex="0" >
                                <Tabs>
                                    <telerik:RadTab Text="Mantenimiento Solicitantes" Width="200px"></telerik:RadTab>
                                ...
                                <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage"  >
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_Solicitantes">
                                                <h1 class="TituloPanelTitulo">Solicitante / Cliente / Programa</h1>
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                                                <ContentTemplate>
                                                    <asp:Button  ID="btnAccion1" runat ="server" Text= "Accion1" Width ="150px" Visible ="false"/>
                                                    <asp:Button ID ="btnAccion2" runat ="server" Text= "Accion2" Width ="150px" Visible ="false"/>      
                                                    <h1></h1>
                                                  <table width="100%" style="border-radius: 10px; border: 1px solid grey; width: 100%; border-collapse: initial;" id="Table1">                      
                                            <tr>
                                                 <td>
                                                    <asp:Label ID="Label3" runat="server" Text="Num.Solicitante"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox CssClass="TextBoxBusqueda" ID="txtIdSolicitante" runat="server" Width="85px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                                    <asp:Button runat="server" ID="AccionBuscar1" Text="AccionBuscar1" />
                                                </td>
                                            </tr>
                                              <tr>
                                                <td> 
                                                ...
                                                <td>
                                                    <asp:DropDownList runat="server" ID="ddlIdCompania" Class="TexboxNormal" Width="300px"  AutoPostBack ="True"></asp:DropDownList>
                                                </td>      
                                            </tr>
                                            <tr>
                                                <td> 
                                                ...
                                                <td>
                                                    <asp:TextBox runat="server" ID="txtNombre0" Class="TexboxNormal" Width="200px" ></asp:TextBox>
                                                </td>      
                                            </tr>                                   
                                            <tr>
                                                 <td>
                                                ...
                                                <td>
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txmDescripcion" TextMode="MultiLine" Width="250px" ></asp:TextBox>
                                                </td>
                                            </tr>
                                                <tr>
                                                 <td>
                                                ...
                                                <td>
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txmDireccionFisica" TextMode="MultiLine" Width="250px" ></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>      
                                                <td>
                                                ...
                                                <td>
                                                    <asp:TextBox CssClass="TexboxNormal" ID="txtNombreContacto1" runat="server" Width="250px" ></asp:TextBox>  
                                                </td>
                                                  <td> 
                                                    <asp:Label ID="Label5" runat="server" Text="Email"></asp:Label>       
                                                </td>
                                                <td>
                                                    <asp:TextBox  CssClass="TexboxNormal" ID="txtEmailContacto1" runat="server" Width="200px"></asp:TextBox>
                                                </td>   
                                                  <td> 
                                                    <asp:Label ID="Label22" runat="server" Text="Telefono"></asp:Label>       
                                                </td>
                                                <td>
                                                    <asp:TextBox  CssClass="TexboxNormal" ID="txtTelefonoContacto1" runat="server" Width="100px"></asp:TextBox>
                                                </td>   
                                            </tr>  
                                             <tr>      
                                                 <td>
                                                    <asp:Label ID="Label7" runat="server" Text="Nombre Contacto(2)"></asp:Label>       
                                                </td>
                                                <td>
                                                    <asp:TextBox CssClass="TexboxNormal" ID="txtNombreContacto2" runat="server" Width="250px" ></asp:TextBox>  
                                                </td>
                                                  <td> 
                                                    <asp:Label ID="Label23" runat="server" Text="Email"></asp:Label>       
                                                </td>
                                                <td>
                                                    <asp:TextBox  CssClass="TexboxNormal" ID="txtEmailContacto2" runat="server" Width="200px"></asp:TextBox>
                                                </td>   
                                                  <td> 
                                                    <asp:Label ID="Label24" runat="server" Text="Telefono"></asp:Label>       
                                                </td>
                                                <td>
                                                    <asp:TextBox  CssClass="TexboxNormal" ID="txtTelefonoContacto2" runat="server" Width="100px"></asp:TextBox>
                                                </td>   
                                            </tr>                       
                                               <tr>
                                                <td></td>
                                            ...
                                            <asp:Panel runat="server"  CssClass="TituloPanelVistaDetalle" ID="Vista_Solicitantes0">
                                                <h1 class="TituloPanelTitulo">Lista solicitantes</h1>
