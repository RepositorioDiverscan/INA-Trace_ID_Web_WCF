<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_Contrato.aspx.cs" Inherits="Diverscan.MJP.UI.AppsDiverscan.Contratos.Operaciones.wf_Contrato" %>
                        ...
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               <telerik:RadTabStrip  AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1"  MultiPageID="RadMultiPage1" SelectedIndex="0" >
                                <Tabs>
                                    <telerik:RadTab Text="Contrato" Width="100px"></telerik:RadTab>
                                ...
                                <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage"  >
                                        ...
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  > 
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                                                ...
                                                <td >     
                                                      <asp:DropDownList ID="ddlIdEmpresa" runat="server" Width="255px" AutoPostBack="True"></asp:DropDownList>    
                                                </td>
                                                </tr>
                                                <tr>
                                                <td>
                                                    <asp:Label ID="Label43" runat="server" Text="Vendedor Empresa"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:DropDownList ID="ddlIdVendedorEmpresa" runat="server" Width="255px" AutoPostBack="True"></asp:DropDownList>                
                                                </td>
                                                </tr>
                                                <tr>
                                                <td>
                                                ...
                                                <td >     
                                                    <asp:DropDownList ID="ddlIdContacto" runat="server" Width="255px" AutoPostBack="True"></asp:DropDownList>                
                                                </td>
                                                </tr>   
                                                <tr>
                                                <td>
                                                ...
                                                <td >     
                                                   <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtTelefono" Width="255px" ></asp:TextBox>               
                                                </td>
                                                </tr>
                                                <tr>
                                                 <td>
                                                ...
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtEmail" Width="255px" ></asp:TextBox>
                                                    
                                                </td>
                                                </tr>
                                                <tr>
                                                <td>
                                                    <asp:Label ID="Label30" runat="server" Text="Producto"></asp:Label> 
                                                </td>
                                                <td >     
                                                      <asp:DropDownList ID="ddlIdProducto" runat="server" Width="255px" AutoPostBack="True"></asp:DropDownList>                           
                                                </td>
                                                </tr>                            
                                                <tr>
                                                <td>
                                                    <asp:Label ID="Label31" runat="server" Text="Numero Serie"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtNumSerie" Width="255px" ></asp:TextBox>
                                                </td>
                                                </tr>
                                                <tr>
                                                <td>
                                                    <asp:Label ID="Label32" runat="server" Text="Fecha Inicio"></asp:Label> 
                                                </td>
                                                <td >     

                                                    <asp:Calendar ID = "Calendar2"  BackColor="Gray" DayHeaderStyle-Font-Bold="true" DayHeaderStyle-ForeColor="White" 
                                                     DayStyle-ForeColor="White" NextPrevFormat="FullMonth" OtherMonthDayStyle-ForeColor="White" TitleStyle-ForeColor="White" SelectorStyle-ForeColor="White" TitleStyle-Font-Bold="true" TitleStyle-BackColor="#666699"
                                                     BorderStyle="Double"  runat = "server" SelectionMode="DayWeekMonth" Width="150px" OnSelectionChanged="Calendar2_SelectionChanged"></asp:Calendar>

                                                       <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtFechaInicio" Visible="True" Width="250px" ></asp:TextBox>
                                                </td>
                                                </tr>
                                                <tr>
                                                <td>
                                                    <asp:Label ID="Label33" runat="server" Text="Fecha Expira"></asp:Label> 
                                                </td>
                                                <td>     
                                                    <asp:Calendar ID = "Calendar1"  BackColor="Gray" DayHeaderStyle-Font-Bold="true" DayHeaderStyle-ForeColor="White" 
                                                     DayStyle-ForeColor="White" NextPrevFormat="FullMonth" OtherMonthDayStyle-ForeColor="White" TitleStyle-ForeColor="White" SelectorStyle-ForeColor="White" TitleStyle-Font-Bold="true" TitleStyle-BackColor="#666699"
                                                     BorderStyle="Double"  runat = "server" SelectionMode="DayWeekMonth" Width="150px" OnSelectionChanged="Calendar1_SelectionChanged"></asp:Calendar>
                                                    
                                                     <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtFechaExpira" Visible ="True" Width="250px" ></asp:TextBox>                            
                                                </td>
                                                <tr>
                                               <%-- <td>
                                                    <asp:Label ID="Label34" runat="server" Text="Tiempo Faltante"></asp:Label> 
                                                </td>
                                                <td >     
                                                ...
                                                <td>
                                                    <asp:Label ID="Label35" runat="server" Text="Tiempo Respuesta"></asp:Label> 
                                                </td>
                                                <td >     
                                                ...
                                                <tr>
                                                <td>
                                                    <asp:Label ID="Label36" runat="server" Text="Tiempo Resolución"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtTiempoResolucion" Width="250px" ></asp:TextBox>               
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label37" runat="server" Text="Hora Atención"></asp:Label> 
                                                </td>
                                                <td >     
                                                ...
                                                <tr>
                                                <td>
                                                    <asp:Label ID="Label38" runat="server" Text="Visitas por año"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtNumVisitasAno" Width="250px" ></asp:TextBox>               
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label40" runat="server" Text="Localidades Contrato"></asp:Label> 
                                                </td>
                                                <td >     
                                                ...
                                                <td>
                                                    <asp:Label ID="Label42" runat="server" Text="Dia Facturación"></asp:Label> 
                                                </td>
                                                <td >     
                                                ...
                                                <tr>
                                                <td>
                                                    <asp:CheckBox runat="server" Text="Horas Consumo" ID="chkHorasConsumo"/>
                                                </td>
                                                <td>
                                                </td>
                                                <td>
                                                ...
                                                <tr>
                                                   <td>
                                                   <asp:CheckBox runat="server" Text="Servicios a Terceros" ID="chkServiciosTerceros"/>
                                                   </td>
                                                   <td>
                                                   </td>
                                                   <td>
