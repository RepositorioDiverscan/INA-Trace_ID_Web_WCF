<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_DuracionBodegaDestino.aspx.cs" Inherits="Diverscan.MJP.UI.Administracion.Operacion.wf_DuracionBodegaDestino" %>
                                ...
                                <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage"  >
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_DuracionBodegaDestino">
                                                <h1 class="TituloPanelTitulo">Datos de la duracion promedio</h1>
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <table width="100%" style="border-radius: 10px; border: 1px solid grey; width: 100%; border-collapse: initial;" id="Table1">                      
                                                    <tr>
                                                        ...
                                                        <td >     
                                                            <asp:TextBox CssClass="TextBoxBusqueda" ID="txtidDuracionBodegaDestino" runat="server" Width="50px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                                   ...
                                                   <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox runat="server" ID="txtNombre" Class="TexboxNormal" Width="250px" ></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr> 
                                                    <td>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlidDestino0" Class="TexboxNormal"  runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                <tr>
                                                <tr> 
                                                    ...
                                                    <td>
                                                        <asp:Label ID="Label7" runat="server" Text="Tiempos estimado(horas)"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtTiempoEstimadoHoras"  Width="50px" ></asp:TextBox>
                                                    </td>
                                                </tr>  
                                                 <tr>
                                                    <td>
                                            ...
                                            <asp:Panel runat="server"  CssClass="TituloPanelVistaDetalle" ID="Vista_DuracionBodegaDestino0">
                                                <h1 class="TituloPanelTitulo">Listado Duraciones Bodega - Destino</h1> 
                                            </asp:Panel>
