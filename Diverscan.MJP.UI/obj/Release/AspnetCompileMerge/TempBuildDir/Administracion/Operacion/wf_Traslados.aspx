<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_Traslados.aspx.cs" Inherits="Diverscan.MJP.UI.Administracion.Operacion.wf_Traslados" %>
                        ...
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               <telerik:RadTabStrip  AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1"  MultiPageID="RadMultiPage1" SelectedIndex="0" >
                                <Tabs>
                                    <telerik:RadTab Text="Tipo Traslado" Width="200px"></telerik:RadTab>
                                    <telerik:RadTab Text="Detalle Traslado" Width="200px" ></telerik:RadTab>
                                ...
                                <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage"  >
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_TipoTraslado">
                                                <h1 class="TituloPanelTitulo">Mantenimiento Tipo Traslado</h1>
                                            ...
                                            <tr>
                                                 <td>
                                                    <asp:Label ID="Label3" runat="server" Text="Id Tipo Traslado"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox CssClass="TextBoxBusqueda" ID="txtidTipoTraslado" runat="server" Width="85px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                   <asp:TextBox CssClass="TexboxNormal" ID="txmComentarios" runat="server" Width="300px" TextMode="MultiLine" Height="50px"></asp:TextBox>
                                                </td>
                                            </tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="Label4" runat="server" Text="Metodo/Accion"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddlNombre" Class="TexboxNormal" runat="server" Width="300px" AutoPostBack="True" ></asp:DropDownList>
                                                </td>
                                            ...
                                            <asp:Panel runat="server"  CssClass="TituloPanelVistaDetalle" ID="Vista_TipoTraslado0">
