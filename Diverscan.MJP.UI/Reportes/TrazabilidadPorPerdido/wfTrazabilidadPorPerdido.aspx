<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfTrazabilidadPorPerdido.aspx.cs" Inherits="Diverscan.MJP.UI.Reportes.TrazabilidadPorPerdido.wfTrazabilidadPorPerdido" %>
                    ...
                    <telerik:RadWindow ID="WinUsuarios" runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID" AutoSize="true">
                        <ContentTemplate>
                            <telerik:RadTabStrip AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" SelectedIndex="0">
                                <Tabs>
                                    <telerik:RadTab Text="Trazabilidad por Pedido" Width="200px"></telerik:RadTab>
                                </Tabs>
                            </telerik:RadTabStrip>
                                    ...
                                    <asp:Panel ID="Panel1" runat="server" Class="TabContainer">
                                        ...
                                        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                            <ContentTemplate>
                                                ...
                                                <asp:Button runat="server" ID="btnReporteTrazabilidad" Text="Trazabilidad" AutoPostBack="false" OnClientClick="DisplayLoadingImage1()" onclick="btnReporteTrazabilidad_Click" 
                                                    PostBackUrl="~/Reportes/TrazabilidadPorPerdido/wfTrazabilidadPorPerdido.aspx" />
                                                 ...
                                                 <telerik:RadGrid RenderMode="Lightweight" ID="RGArticulosPedido" runat="server" ShowStatusBar="true" AutoGenerateColumns="False"
                                                    ...
                                                    <MasterTableView DataKeyNames="IdMaestroSolicitud" AllowMultiColumnSorting="True">
                                                        <DetailTables>
                                                            <telerik:GridTableView DataKeyNames="IdInternoArticulo" Name="Articulos" 
                                                                ...
                                                                <Columns>
                                                                  ...
                                                                  <telerik:GridBoundColumn SortExpression="CantidadAlistada" HeaderText="Cantidad" HeaderButtonType="TextButton"
                                                        ...
                                                        <Columns>                                                            
                                                            ...
                                                            <telerik:GridBoundColumn SortExpression="IdMaestroSolicitud" HeaderText="Id Pedido" HeaderButtonType="TextButton"
                                                                DataField="IdMaestroSolicitud" >
                                                            </telerik:GridBoundColumn>
