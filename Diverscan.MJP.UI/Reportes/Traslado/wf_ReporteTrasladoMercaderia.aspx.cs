...
namespace Diverscan.MJP.UI.Reportes.Traslado
{
    public partial class wf_ReporteTrasladoMercadería : System.Web.UI.Page
    {
        private readonly IReportes _reportes;
        private e_Usuario UsrLogged = new e_Usuario();

        public wf_ReporteTrasladoMercadería()
        {
        ...
        private List<EListObtenerTrasladoMercaderia> _listTrasaldo
        {
            get
            {
                var data = ViewState["TrasladoM"] as List<EListObtenerTrasladoMercaderia>;
                if (data == null)
                {
                    data = new List<EListObtenerTrasladoMercaderia>();
                    ViewState["TrasladoM"] = data;
                }
                return data;
            }
            set { ViewState["TrasladoM"] = value; }
        }
        ...
        protected void RGTrasladoMercaderia_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
        {
            RGTrasladoMercaderia.DataSource = _listTrasaldo;
        }
        ...
        private void ObtenerTrasladoMercaderia(EObtenerTrasladoMercaderia obtenerTrasladoMercaderia)
        {
            try
            {
                _listTrasaldo = _reportes.ObtenerTrasladoMercaderia(obtenerTrasladoMercaderia);
                RGTrasladoMercaderia.DataSource = _listTrasaldo;
                RGTrasladoMercaderia.DataBind();
        ...
        protected void btnBusqueda_Click(object sender, EventArgs e)
        {
            if (ValidarEspacios())
            {
                ...
                EObtenerTrasladoMercaderia obtenerTrasladoMercaderia = new EObtenerTrasladoMercaderia()
                {
                ...
                ObtenerTrasladoMercaderia(obtenerTrasladoMercaderia);
            }
        }
        ...
        private void GenerarReporte()
        {
            ...
            try
            {
                PropertyDescriptorCollection properties = TypeDescriptor.GetProperties(typeof(EListObtenerTrasladoMercaderia));
                ...
                propertiesSelected[2] = properties.Find("Usuario", false);
                propertiesSelected[3] = properties.Find("Unidades", false);
                var propertySelected = new PropertyDescriptorCollection(propertiesSelected);
                var rutaVirtual = "~/temp/" + string.Format("TrasladoMercaderia.xlsx");
                var fileName = Server.MapPath(rutaVirtual);
                List<string> headers = new List<string>() { "SKU", "Nombre de Artículo", "Usuario", "Unidades" };
                ExcelExporter.ExportData(_listTrasaldo, fileName, propertySelected, headers);
