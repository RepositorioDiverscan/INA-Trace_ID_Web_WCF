<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_ReporteTrasladoMercaderia.aspx.cs" Inherits="Diverscan.MJP.UI.Reportes.Traslado.wf_ReporteTrasladoMercadería" %>
                    ...
                    <telerik:RadWindow ID="WinUsuarios" runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID" AutoSize="true">
                        <ContentTemplate>
                            <telerik:RadTabStrip AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" SelectedIndex="0">
                                <Tabs>
                                    <telerik:RadTab Text="Trasalados de Mercadería" Width="200px"></telerik:RadTab>
                                </Tabs>
                            </telerik:RadTabStrip>
                                    ...
                                    <asp:Panel ID="Panel1" runat="server" Class="TabContainer">
                                        ...
                                        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                            <ContentTemplate>
                                                ...
                                                <table width="98%" style="border-radius: 10px; border: 1px solid grey; border-collapse: initial; margin-left: 1%;margin-top:10px" id="Table1">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <asp:TextBox ID="txtSKU" runat="server" AutoPostBack="true" Class="TexboxNormal" Width="200px" Style="margin-top:5px; margin-left:20px;"></asp:TextBox>
                                                            ...
                                                            <asp:Button runat="server" ID="btnGenerarReporte" Style="margin-left: 10px" Text="GenerarReporte" OnClick="btnGenerarReporte_Click" PostBackUrl="~/Reportes/Traslado/wf_ReporteTrasladoMercaderia.aspx" />
                                                        </td>
                                                    </tr>
                                                ...
                                                <asp:Panel runat="server" ID="PanelTrasladoMercaderia" Visible="true">
                                                    <telerik:RadGrid
                                                        ID="RGTrasladoMercaderia"
                                                        AllowPaging="True"
                                                        Width="98%"
                                                        Style="margin-left: 1%"
                                                        runat="server"
                                                        ...
                                                        OnNeedDataSource="RGTrasladoMercaderia_NeedDataSource"
