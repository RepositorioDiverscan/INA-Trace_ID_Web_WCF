<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_ReporteRotacionInventario.aspx.cs" Inherits="Diverscan.MJP.UI.Reportes.RotacionInventario.wf_ReporteRotacionInventario" %>
                    ...
                    <telerik:RadWindow ID="WinUsuarios" runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID" AutoSize="true">
                        <ContentTemplate>
                            <telerik:RadTabStrip AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" SelectedIndex="0">
                                <Tabs>
                                    <telerik:RadTab Text="Rotación de Inventario" Width="200px"></telerik:RadTab>
                                </Tabs>
                            </telerik:RadTabStrip>
                                    ...
                                    <asp:Panel ID="Panel1" runat="server" Class="TabContainer">
                                        ...
                                        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                            <ContentTemplate>
                                                ...
                                                <table width="98%" style="border-radius: 10px; border: 1px solid grey; border-collapse: initial; margin-left: 1%;margin-top:10px" id="Table1">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <asp:Button runat="server" ID="btnGenerarReporte" Style="margin-left: 10px" Text="GenerarReporte" OnClick="btnGenerarReporte_Click" PostBackUrl="~/Reportes/RotacionInventario/wf_ReporteRotacionInventario.aspx" />
                                                        </td>
                                                    </tr>
                                                ...
                                                <asp:Panel runat="server" ID="PanelRotacionInventario" Visible="true">
                                                    <telerik:RadGrid
                                                        ID="RGRotacionInventario"
                                                        AllowPaging="True"
                                                        Width="98%"
                                                        Style="margin-left: 1%"
                                                        runat="server"
                                                        ...
                                                        OnNeedDataSource="RGRotacionInventario_NeedDataSource"
                                                        ...
                                                        <MasterTableView>
                                                            <Columns>
                                                                <telerik:GridBoundColumn UniqueName="UnidadesFrecuencia" Visible="true"
                                                                    SortExpression="UnidadesFrecuencia" HeaderText="Unidades de Frecuencia" DataField="UnidadesFrecuencia">
                                                                ...
                                                                <telerik:GridBoundColumn UniqueName="Promedio"
                                                                    SortExpression="Promedio" HeaderText="Promedio" DataField="Promedio">
                                                                </telerik:GridBoundColumn>
