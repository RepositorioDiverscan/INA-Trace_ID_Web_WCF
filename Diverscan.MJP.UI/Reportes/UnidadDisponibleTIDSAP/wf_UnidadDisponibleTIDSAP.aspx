<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_UnidadDisponibleTIDSAP.aspx.cs" Inherits="Diverscan.MJP.UI.Reportes.UnidadDisponibleTIDSAP.wf_UnidadDisponibleTIDSAP" %>
                    ...
                    <telerik:RadWindow ID="WinUsuarios" runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID" AutoSize="true">
                        <ContentTemplate>
                            <telerik:RadTabStrip AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" SelectedIndex="0">
                                <Tabs>
                                    <telerik:RadTab Text="Unidad Disponible TID/SAP" Width="200px"></telerik:RadTab>
                                </Tabs>
                            </telerik:RadTabStrip>
                                    ...
                                    <asp:Panel ID="Panel1" runat="server" Class="TabContainer">
                                        ...
                                        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                            <ContentTemplate>
                                                ...
                                                <table width="98%" style="border-radius: 10px; border: 1px solid grey; border-collapse: initial; margin-left: 1%;margin-top:10px" id="Table1">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <asp:TextBox ID="txtSKU" runat="server" AutoPostBack="true" Class="TexboxNormal" Width="200px" Style="margin-left: 20px;margin-top:10px;"></asp:TextBox>
                                                            ...
                                                            <asp:Button runat="server" ID="btnGenerarReporte" Style="margin-left: 10px" Text="GenerarReporte" OnClick="btnGenerarReporte_Click" PostBackUrl="~/Reportes/UnidadDisponibleTIDSAP/wf_UnidadDisponibleTIDSAP.aspx" />
                                                        </td>
                                                    </tr>
                                                ...
                                                <asp:Panel runat="server" ID="PanelUnidadDisponible" Visible="true">
                                                    <telerik:RadGrid
                                                        ID="RGUnidadDisponible"
                                                        AllowPaging="True"
                                                        Width="98%"
                                                        Style="margin-left: 1%"
                                                        runat="server"
                                                        ...
                                                        OnNeedDataSource="RGUnidadDisponible_NeedDataSource"
                                                        ...
                                                        <MasterTableView>
                                                            <Columns>
                                                                ...
                                                                <telerik:GridBoundColumn UniqueName="UnidadTraceID"
                                                                    SortExpression="UnidadTraceID" HeaderText="Unidades en TraceID" DataField="UnidadTraceID">
                                                                </telerik:GridBoundColumn>

                                                                <telerik:GridBoundColumn UniqueName="UnidadSAP" Visible="true"
                                                                    SortExpression="UnidadSAP" HeaderText="Unidades en SAP" DataField="UnidadSAP">
                                                                </telerik:GridBoundColumn>

                                                                <telerik:GridBoundColumn UniqueName="Diferencia"
                                                                    SortExpression="Diferencia" HeaderText="Diferencia" DataField="Diferencia">
                                                                </telerik:GridBoundColumn>
