...
namespace Diverscan.MJP.UI.Reportes
{
    public partial class wf_DespachosPorPedido : System.Web.UI.Page
    {
        ...
        protected void btnExportarDetalleSolicitudDespacho_Click(object sender, EventArgs e)
        {
            ...
            {
                PropertyDescriptorCollection properties = TypeDescriptor.GetProperties(typeof(e_Detalle_Despacho_Por_Numero_Solicitud));

                PropertyDescriptor[] propertiesSelected = new PropertyDescriptor[11];
                propertiesSelected[0] = properties.Find("Codigo", false);
                //propertiesSelected[1] = properties.Find("Lote", false);
                propertiesSelected[1] = properties.Find("Descripcion", false);
                propertiesSelected[2] = properties.Find("Bultos", false);
                //propertiesSelected[4] = properties.Find("Und", false);
                propertiesSelected[3] = properties.Find("SSCCEtiqueta", false);
                ...
                propertiesSelected[7] = properties.Find("AlistadoUF", false);
                propertiesSelected[8] = properties.Find("EmpaqueUF", false);
                propertiesSelected[9] = properties.Find("Costo", false);
                propertiesSelected[10] = properties.Find("Total", false);
                ...
                List<string> headerDetalle = new List<string>() { "Código", "Descripción", "Und.Alisto Solicitud", "SSCC", "PedidoUnd.Inventario", "AlistadoUnd.Inventario", "Und.Medida UI", "AlistadoUnd.Física","Empaque", "Costo", "Total" };
        ...
        private List<e_Detalle_Despacho_Por_Numero_Solicitud> _Detalle_Despacho_Por_Numero_Solicitud
        {
            get
            {
                var data = ViewState["DataDetalleDespachoPorNumeroSolicitud"] as List<e_Detalle_Despacho_Por_Numero_Solicitud>;
                if (data == null)
                {
                    data = new List<e_Detalle_Despacho_Por_Numero_Solicitud>();
        ...
        //private bool validarNumeroSolicitudIngresado()
        //{
        //    try
        //    {
        //        long aux = ((long)Convert.ToDouble(txtBuscarNumSolicitud.Text.ToString()));
        //        return true;
        //    }
        //    catch (Exception)
        //    {
        //        Mensaje("error", "Ingrese un valor númerico entero en [Número solicitud]", "");
        //        return false;
        //    }
        //}
        ...
        protected void radGridDetalleDespachoSolicitud_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                var listaNumSolicitudDespachoDetalle = _Despachos.ObtenerDetalleDespachoPorNumeroSolicitud(numSolicitudSeleccionada, ref fechaPedidoOUT, ref destinoDescripcion, ref idInternoSolicitud, ref idSolicitudTID);
            ...
            /*
                             if (validarNumeroSolicitud())
                {
                    try
                    {
                        radGridDetalleDespachoSolicitud.DataSource = null;
                        radGridDetalleDespachoSolicitud.DataBind();
                        var listaNumSolicitudDespachoDetalle = _Despachos.ObtenerDetalleDespachoPorNumeroSolicitud(numSolicitud, ref fechaPedidoOUT, ref destinoDescripcion, ref idInternoSolicitud, ref idSolicitudTID);
                        radGridDetalleDespachoSolicitud.DataSource = listaNumSolicitudDespachoDetalle;
                        radGridDetalleDespachoSolicitud.DataBind();
                        _Detalle_Despacho_Por_Numero_Solicitud = listaNumSolicitudDespachoDetalle;
                        ...
                        else
                        {
                            ...
                            lbFechaPedido.Text = fechaPedidoOUT.ToShortDateString();
                            subTotal = _Despachos.ObtenerSubTotalDespachoPorNumSolitud(listaNumSolicitudDespachoDetalle);
                            lbSubTotal.Text = subTotal.ToString();
                            lbDestinoPedido.Text = destinoDescripcion;
                            lbIdInternoSolicitud.Text = idInternoSolicitud;
