<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_HistoricoDemanda.aspx.cs" Inherits="Diverscan.MJP.UI.Reportes.HistoricoDemanda" %>
                        ...
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true">
                            <ContentTemplate >
                               <telerik:RadTabStrip  AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1"  MultiPageID="RadMultiPage1" SelectedIndex="0" >
                                <Tabs>
                                    <telerik:RadTab Text="Reporte Historico Demanda" Width="230px"></telerik:RadTab>
                                              ...
                                              <tr>
                                                  <td>
                                                      ...
                                                      <%--<asp:Panel runat="server" CssClass="TituloPanelVistaDetalle" ID="Panel5">--%>
                                                          <telerik:RadGrid ID="rdDatosReporteHistoricoDemanda" runat="server" AllowMultiRowSelection="false" PageSize="5" OnItemCommand="RadGrid_ItemCommand"
