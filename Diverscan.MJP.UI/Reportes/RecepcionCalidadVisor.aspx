<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RecepcionCalidadVisor.aspx.cs" Inherits="Diverscan.MJP.UI.Reportes.RecepcionCalidadVisor" %>
                    ...
                    <telerik:RadWindow ID="WinUsuarios" runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID" AutoSize="true">
                        <ContentTemplate>
                            <telerik:RadTabStrip AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1" MultiPageID="RadMultiPage1" SelectedIndex="0">
                                <Tabs>
                                    <telerik:RadTab Text="Recepcion Calidad" Width="200px"></telerik:RadTab>
                                </Tabs>
                            </telerik:RadTabStrip>
                                    ...
                                    <asp:Panel ID="Panel1" runat="server" Class="TabContainer" Height="100%">
                                        <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                ...
                                                <asp:Button runat="server" ID="btnExportar" Text="Exportar a Excel" OnClick="_btnExportar_Click" />
                                                ...
                                                <telerik:RadGrid ID="rdDatosReporte" runat="server" AllowMultiRowSelection="false" PageSize="10"
                                                    ...
                                                    <MasterTableView>
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <telerik:GridBoundColumn UniqueName="Pregunta"
                                                                SortExpression="Pregunta" HeaderText="Pregunta" DataField="Pregunta"
                                                                AllowFiltering="True" AutoPostBackOnFilter="True" CurrentFilterFunction="Contains" ShowFilterIcon="False">
                                                            </telerik:GridBoundColumn>

                                                            <telerik:GridBoundColumn UniqueName="Respuesta"
                                                                SortExpression="Respuesta" HeaderText="Respuesta" DataField="Respuesta"
                                                                AllowFiltering="True" AutoPostBackOnFilter="True" CurrentFilterFunction="Contains" ShowFilterIcon="False">
                                                            </telerik:GridBoundColumn>

                                                            <telerik:GridBoundColumn UniqueName="Comentario" 
                                                                SortExpression="Comentario" HeaderText="Dispositivo" DataField="Comentario"
                                                                AllowFiltering="True" AutoPostBackOnFilter="True" CurrentFilterFunction="Contains" ShowFilterIcon="False">
                                                            </telerik:GridBoundColumn>

                                                            <telerik:GridBoundColumn UniqueName="ComentarioSeparado"
                                                                SortExpression="ComentarioSeparado" HeaderText="Comentario" DataField="ComentarioSeparado"
                                                                AllowFiltering="True" AutoPostBackOnFilter="True" CurrentFilterFunction="Contains" ShowFilterIcon="False">
                                                            </telerik:GridBoundColumn>
                                                            ...
                                                            <telerik:GridBoundColumn UniqueName="UsuarioAutoriza"
                                                                SortExpression="UsuarioAutoriza" HeaderText="Autorizado por" DataField="UsuarioAutoriza"
                                                                AllowFiltering="True" AutoPostBackOnFilter="True" CurrentFilterFunction="Contains" ShowFilterIcon="False">
                                                            </telerik:GridBoundColumn>
