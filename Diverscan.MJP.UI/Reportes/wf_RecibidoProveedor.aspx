<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_RecibidoProveedor.aspx.cs" Inherits="Diverscan.MJP.UI.Reports.wf_RecibidoProveedor" %>
                        ...
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true">
                            <ContentTemplate >
                               <telerik:RadTabStrip  AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1"  MultiPageID="RadMultiPage1" SelectedIndex="0" >
                                <Tabs>
                                    <telerik:RadTab Text="Comparativo Recibido del Proveedor" Width="230px"></telerik:RadTab>
                                  ...
                                  <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                    <asp:Panel ID="Panel1" runat="server" Class="TabContainer">                                        
                                          ...
                                          <table width="100%" style="border-radius: 10px; border: 1px solid grey; width: 100%; border-collapse: initial;" id="Table1">                      
                                            <tr> 
                                              <td>
                                                ...
                                                <asp:DropDownList ID="ddlIDProveedor" Class="TexboxNormal"  runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>
                                                  <div style="display:none">
                                            ...
                                            <tr> 
                                              <td>
                                                <asp:Label ID="LblFechain" runat="server" Text="Fecha Inicial:"></asp:Label> 
                                                <telerik:RadDatePicker ID="RDPFechaInicial" runat="server" AutoPostBack ="true"></telerik:RadDatePicker>
                                              </td>
                                            </tr>
                                            <tr> 
                                              <td>
                                                <asp:Label ID="LblFechafin" runat="server" Text="Fecha Final:"></asp:Label> 
                                                <telerik:RadDatePicker ID="RDPFechaFinal" runat="server" AutoPostBack ="true"></telerik:RadDatePicker>
                                              </td>
                                            </tr>
                                            <tr> 
                                              <td>
                                                <asp:Label ID="LblArticulo" runat="server" Text="Artículo:"></asp:Label> 
                                                <asp:DropDownList ID="DdlIdarticulo" Class="TexboxNormal"  runat="server" Width="200px" AutoPostBack="True"></asp:DropDownList>
                                              </td>
                                            </tr>
                                            <tr>
                                              <td>
                                              ...
                                              <tr>
                                                  <td>
                                                      ...
                                                      <%--<asp:Panel runat="server" CssClass="TituloPanelVistaDetalle" ID="Panel5">--%>
                                                          <telerik:RadGrid ID="rdDatosReporteProveedor" runat="server" AllowMultiRowSelection="false" PageSize="5" OnItemCommand="RadGrid_ItemCommand"
                                                              ...
                                                              <MasterTableView>
                                                                    <Columns>
                                                        <telerik:GridBoundColumn UniqueName="OrdenCompra"
                                                                                SortExpression="OrdenCompra" HeaderText="OrdenCompra" DataField="OrdenCompra">
                                                                            </telerik:GridBoundColumn>
                                                        <telerik:GridBoundColumn UniqueName="Proveedor"
                                                                                SortExpression="Proveedor" HeaderText="Proveedor" DataField="Proveedor">
                                                                            </telerik:GridBoundColumn>                                                        
                                                        <telerik:GridBoundColumn UniqueName="ArtSap"
                                                                                SortExpression="ArtSap" HeaderText="ArticuloSAP" DataField="ArtSap">
                                                                            </telerik:GridBoundColumn>
                                                        ...
                                                        <telerik:GridBoundColumn UniqueName="CantidadRecibidaMostrar"
                                                                                SortExpression="CantidadRecibidaMostrar" HeaderText="CantidadRecibida" DataField="CantidadRecibidaMostrar">
                                                                            </telerik:GridBoundColumn>
                                                        <telerik:GridBoundColumn UniqueName="CantidadPorRecibir"
                                                                                SortExpression="CantidadPorRecibir" HeaderText="CantidadPorRecibir" DataField="CantidadPorRecibir">
                                                                            </telerik:GridBoundColumn>
                                                        <telerik:GridBoundColumn UniqueName="DiferenciaMostrar"
                                                                                SortExpression="DiferenciaMostrar" HeaderText="Diferencia" DataField="DiferenciaMostrar">
                                                                            </telerik:GridBoundColumn>
                                      ...
                                      <telerik:RadGrid ID="RadGrid1"  runat="server"  AllowMultiRowSelection="false" PageSize ="10"  onitemcommand="RadGrid_ItemCommand"   
                                                        ...
                                                        OnNeedDataSource = "RadGrid_NeedDataSource" Visible ="false" AutoGenerateColumns="false">
                                             <ClientSettings EnableRowHoverStyle="true" Selecting-AllowRowSelect="false" EnablePostBackOnRowClick="true">
                                               <Selecting AllowRowSelect="false" ></Selecting>
                                                 <Scrolling AllowScroll="True"  UseStaticHeaders="false" SaveScrollPosition="true" FrozenColumnsCount="2"></Scrolling>                                               
                                               </ClientSettings>
