<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_Productos.aspx.cs" Inherits="Diverscan.MJP.UI.AppsDiverscan.Contratos.Mantenimiento.wf_Productos" %>
                    ...
                    <Windows >
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               ...
                               <Tabs>
                                    <telerik:RadTab Text="Productos" Width="200px"></telerik:RadTab>
                                ...
                                <telerik:RadMultiPage runat="server" ID="RadMultiPage1"  SelectedIndex="0" CssClass="outerMultiPage"  >
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_Contratos_Productos">
                                                <h1 class="TituloPanelTitulo">Mantenimiento Productos</h1>
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                                             ...
                                             <tr>
                                                ...
                                                <td >     
                                                    <asp:TextBox CssClass="TextBoxBusqueda" ID="txtidProducto" runat="server" Width="85px" AutoCompleteType="Disabled" ></asp:TextBox>   
                                             ...
                                             <tr>
                                                 <td>
                                                    <asp:Label ID="Label1" runat="server" Text="Numero Parte"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtNumeroParte" Width="250px" ></asp:TextBox>
                                             ...
                                             <tr>
                                                 <td>
                                                    <asp:Label ID="Label4" runat="server" Text="Descripcion Fabricante"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtDescripcionFabricante" Width="250px" ></asp:TextBox>
                                              ...
                                              <tr>
                                                 <td>
                                                    <asp:Label ID="Label12" runat="server" Text="Descripcion Diverscan"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtDescripcionDiverscan" Width="250px" ></asp:TextBox>
                                              ...
                                              <tr>
                                                 <td>
                                                    <asp:Label ID="Label2" runat="server" Text="Productos Asociados"></asp:Label> 
                                                </td>
                                                <td >     
                                                     <asp:TextBox CssClass="TexboxNormal" ID="txmProductosAsociados" runat="server" Width="300px" TextMode="MultiLine" Height="50px"></asp:TextBox>
                                             ...
                                             <tr>
                                                 <td>
                                                    <asp:Label ID="Label5" runat="server" Text="Servicios Asociados"></asp:Label> 
                                                </td>
                                                <td >     
                                                     <asp:TextBox CssClass="TexboxNormal" ID="txmServiciosAsociados" runat="server" Width="300px" TextMode="MultiLine" Height="50px"></asp:TextBox>
                                              ...
                                              <tr>
                                                 <td>
                                                    <asp:Label ID="Label7" runat="server" Text="Tipo Articulo"></asp:Label> 
                                                </td>
                                                <td >     
                                                     <asp:TextBox CssClass="TexboxNormal" ID="txmTipoArticulo" runat="server" Width="300px" TextMode="MultiLine" Height="50px"></asp:TextBox>
                                                ...
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtFechaVencimiento" Width="250px" ></asp:TextBox>
                                                       ...
                                                       <tr>
                                                 <td>
                                                    <asp:Label ID="Label9" runat="server" Text="Arancel"></asp:Label> 
                                                </td>
                                                <td >     
                                                   
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtArancel" Width="250px" ></asp:TextBox>
                                                </td>
                                            </tr>
                                             ...
                                             <tr>
                                                 <td>
                                                    <asp:Label ID="Label10" runat="server" Text="Requerimiento Venta"></asp:Label> 
                                                </td>
                                                <td >     
                                                   
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtRequerimientoVenta" Width="250px" ></asp:TextBox>
                                                ...
                                                <tr>
                                                 <td>
                                                    <asp:Label ID="Label11" runat="server" Text="Margen"></asp:Label> 
                                                </td>
                                                <td >     
                                                    <asp:TextBox runat="server" CssClass="TexboxNormal" ID="txtMargen" Width="250px" ></asp:TextBox>
                                                ...
                                                <tr>
                                                <td>
                                                   <asp:CheckBox runat="server" Text="Estado" ID="chkEstado"/>
                                                </td>
                                                ...
                                                <tr>
                                                <td>
                                                   <asp:CheckBox runat="server" Text="Garantia" ID="chkGarantia"/>
                                                </td>
                                            ...
                                            <asp:Panel runat="server"  CssClass="TituloPanelVistaDetalle" ID="Vista_Contratos_Productos0">
                                                <h1 class="TituloPanelTitulo">Lista Segmentación Empresa</h1>
