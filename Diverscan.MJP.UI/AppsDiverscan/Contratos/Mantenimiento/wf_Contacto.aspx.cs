...
namespace Diverscan.MJP.UI.AppsDiverscan.Contratos.Mantenimiento
{
    public partial class wf_Contacto : System.Web.UI.Page
    {
        ...
        private void CargarDDLS()
        {
            try
            {
               // n_SmartMaintenance.CargarDDLsHoras(Panel1);
                string[] Msj = n_SmartMaintenance.CargarDDL(ddlIdTipoRelacion, e_TablasBaseDatos.TblContratos_TipoRelacion(), UsrLogged.IdUsuario, false);
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            Control Ctr = (Control)sender;
            var Panel = Ctr.Parent.Parent.Parent;
            string[] Msj = n_SmartMaintenance.AgregarDatos(Panel, e_TablasBaseDatos.TblContratos_Contacto(), ToleranciaAgregar, UsrLogged.IdUsuario);
            if (Msj[1] != "") Mensaje(Msj[0], Msj[1], "");
        }
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            Control Ctr = (Control)sender;
            var Panel = Ctr.Parent.Parent.Parent;
            string[] Msj = n_SmartMaintenance.EditarDatos(Panel, e_TablasBaseDatos.TblContratos_Contacto(), UsrLogged.IdUsuario);
            if (Msj[1] != "") Mensaje(Msj[0], Msj[1], "");
        }
