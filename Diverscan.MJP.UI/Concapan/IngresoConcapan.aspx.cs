...
namespace Diverscan.MJP.UI.Concapan
{
    public partial class IngresoConcapan : System.Web.UI.Page
    {
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            Control Ctr = (Control)sender;
            var Panel = Ctr.Parent.Parent.Parent;
            string[] Msj = n_SmartMaintenance.AgregarDatos(Panel, e_TablasBaseDatos.TblOPEINGAnden(), ToleranciaAgregar, UsrLogged.IdUsuario);
            if (Msj[1] != "") Mensaje(Msj[0], Msj[1], "");
        }
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            Control Ctr = (Control)sender;
            var Panel = Ctr.Parent.Parent.Parent;
            string[] Msj = n_SmartMaintenance.EditarDatos(Panel, e_TablasBaseDatos.TblOPEINGAnden(), UsrLogged.IdUsuario);
            if (Msj[1] != "") Mensaje(Msj[0], Msj[1], "");
        }
        ...
        protected void btnAccion91_Click(object sender, EventArgs e)
        {
  
            string CodLeido = txtIdentificacion.Text + ";" + "0" + ";" + "Null";
            string[] respuesta ;
            try
            {
                if (!String.IsNullOrEmpty(txtIdentificacion.Text))
                {
                    if (CheckAlmuerzo.Checked == true)
                    {
                        CodLeido = txtIdentificacion.Text + ";" + "1" +  ";" + "0";
                        //CheckCena.Enabled = false;
                    }
              
                    if(CheckCena.Checked == true)
                    {
                        CodLeido = txtIdentificacion.Text + ";" + "1" + ";" + "1";
                    
                    }
                   
                    string Pagina = "~/HH/Concapan/IngresoConcapan.aspx";
                    respuesta = n_SmartMaintenance.CargarEjecutarAccion(Pagina, CodLeido , UsrLogged.IdUsuario, "btnAccion91").Split(';');
