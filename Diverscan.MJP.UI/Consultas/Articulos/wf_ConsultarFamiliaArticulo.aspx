<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_ConsultarFamiliaArticulo.aspx.cs" Inherits="Diverscan.MJP.UI.Consultas.Articulos.wf_ConsultarFamiliaArticulo" %>
                        ...
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               <telerik:RadTabStrip  AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1"  MultiPageID="RadMultiPage1" SelectedIndex="0" >
                                <Tabs>
                                    <telerik:RadTab Text="Familia Articulo" Width="200px"></telerik:RadTab>
                                </Tabs>
                                </telerik:RadTabStrip>
                                    ...
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_OC">
                                                <h1 class="TituloPanelTitulo">Datos de la Familia Articulo</h1>
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                                                ...
                                                <h1 class="TituloPanelTitulo">Listado de Familia Articulo</h1> 
                                            </asp:Panel>
                                            <telerik:RadGrid ID="RadGridFamiliaArticulo" AllowPaging="True" Width="100%" OnClientClick="DisplayLoadingImage1()"  OnNeedDataSource ="RadGridFamiliaArticulo_NeedDataSource"
                                                        runat="server" AutoGenerateColumns="False" AllowSorting="True" PageSize="10" AllowMultiRowSelection="true" OnItemCommand="RadGridFamiliaArticulo_ItemCommand">
                                                         <MasterTableView>
                                                            <Columns>
                                                              ...
                                                              <%--   <telerik:GridBoundColumn UniqueName="idCompania"
                                                                ...
                                                                <telerik:GridBoundColumn UniqueName="toxico"
                                                                    SortExpression="toxico" HeaderText="Toxico" DataField="toxico">
                                                                </telerik:GridBoundColumn>
