<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="wf_ConsultaArticulosxProveedor.aspx.cs" Inherits="Diverscan.MJP.UI.Consultas.Proveedores.wf_ConsultaArticulosxProveedor" %>
                        ...
                        <telerik:RadWindow  ID="WinUsuarios"  runat="server" VisibleStatusbar="false" VisibleOnPageLoad="true" RestrictionZoneID="RestrictionZoneID"  AutoSize="true"  >
                            <ContentTemplate >
                               <telerik:RadTabStrip  AutoPostBack="false" RenderMode="Lightweight" runat="server" ID="RadTabStrip1"  MultiPageID="RadMultiPage1" SelectedIndex="0" >
                                <Tabs>
                                    <telerik:RadTab Text="Articulos por Proveedor" Width="200px"></telerik:RadTab>
                                </Tabs>
                                </telerik:RadTabStrip>
                                    ...
                                    <telerik:RadPageView runat="server" ID="RadPageView1"  >
                                        <asp:Panel ID="Panel1" runat="server" Class="TabContainer"  >                                        
                                            <asp:Panel runat="server"  CssClass="TituloPanelVista" ID="Vista_OC">
                                                <h1 class="TituloPanelTitulo">Datos de articulos por proveedor</h1>
                                            ...
                                            <asp:UpdatePanel runat="server" ID="UpdatePanel1" >
                                                ...
                                                <h1 class="TituloPanelTitulo">Consulta Articulo x Proveedor</h1> 
                                            </asp:Panel>
                                            <telerik:RadGrid ID="RadGridArticuloxProveedor" AllowPaging="True" Width="100%" OnClientClick="DisplayLoadingImage1()" 
                                                        runat="server" AutoGenerateColumns="False" AllowSorting="True" PageSize="10" AllowMultiRowSelection="true" 
                                                        OnNeedDataSource="RadGridArticuloxProveedor_NeedDataSource" PagerStyle-AlwaysVisible="true">
                                                         <MasterTableView>
                                                            <Columns>
                                                                ...
                                                                <telerik:GridBoundColumn UniqueName="idInterno"
                                                                    SortExpression="idInterno" HeaderText="Id Interno" DataField="idArticulo">
                                                                </telerik:GridBoundColumn>                                                              
                                                             
                                                                <telerik:GridBoundColumn UniqueName="Nombre"
                                                                    SortExpression="Nombre" HeaderText="Descripcion Articulo" DataField="Nombre">
                                                                </telerik:GridBoundColumn>
