...
namespace Diverscan.MJP.Entidades.TRAIngresoSalidaArticulos
{ 
    public class TRAIngresoSalidaArticulosRecord
    {
        public TRAIngresoSalidaArticulosRecord(long idRegistro, bool sumUno_RestaCero, long idArticulo, DateTime fechaVencimiento,
        ...
        public TRAIngresoSalidaArticulosRecord(IDataReader reader)
        {
        ...
        public TRAIngresoSalidaArticulosRecord(bool sumUno_RestaCero, long idArticulo, DateTime fechaVencimiento,
          string lote, int idUsuario, long idMetodoAccion, string idTablaCampoDocumentoAccion, string idCampoDocumentoAccion,
          string numDocumentoAccion, long idUbicacion, decimal cantidad, bool procesado, DateTime fecharegistro, int idEstado)
        {
            SumUno_RestaCero = sumUno_RestaCero;
        ...
        public TRAIngresoSalidaArticulosRecord()
        {
